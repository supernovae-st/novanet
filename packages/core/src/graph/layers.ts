...
export const NODE_LAYERS: Record<NodeType, Layer> = {
  ...
  // config (2 nodes) - matches models/node-kinds/shared/config/
  ...
  // knowledge (26 nodes) - matches models/node-kinds/shared/knowledge/
  ...
  SEOComparison: 'knowledge',
  SEOKeyword: 'knowledge',
  SEOKeywordMetrics: 'knowledge',
  SEOPreposition: 'knowledge',
  SEOQuestion: 'knowledge',
  Taboo: 'knowledge',
  TabooSet: 'knowledge',
  Term: 'knowledge',
  TermSet: 'knowledge',
