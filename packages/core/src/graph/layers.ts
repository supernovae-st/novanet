...
export const NODE_LAYERS: Record<NodeType, Layer> = {
  ...
  // config (14 nodes) - matches models/node-kinds/global/config/
  Adaptation: 'config',
  Continent: 'config',
  Culture: 'config',
  ...
  // output (3 nodes) - matches models/node-kinds/tenant/output/
  ...
  // seo (8 nodes) - matches models/node-kinds/tenant/seo/
  GEOAnswer: 'seo',
  GEOMetrics: 'seo',
  GEOQuery: 'seo',
  SEOComparison: 'seo',
