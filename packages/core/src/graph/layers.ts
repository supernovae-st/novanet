...
// NODE_LAYERS mapping all 48 node types to their layers
...
export const NODE_LAYERS: Record<NodeType, Layer> = {
  ...
  // config (7 nodes) - matches models/node-kinds/global/config/
  Adaptation: 'config',
  Culture: 'config',
  Formatting: 'config',
  Locale: 'config',
  ...
  // locale-knowledge (12 nodes) - matches models/node-kinds/global/locale-knowledge/
