...
// v0.19.0: Traits deprecated (ADR-024). Function kept for backwards compatibility, returns empty.
function loadTraits(): TraitYaml['trait'][] {
  const traitsDir = join(MODELS_DIR, 'traits');
  // v0.19.0: Traits directory no longer exists - return empty array
...
// =============================================================================
// Trait Tests — DEPRECATED v0.19.0 (ADR-024)
// Traits removed from schema. Provenance is now per-instance on nodes that need it.
// =============================================================================

describe.skip('Design System Coherence: Traits (DEPRECATED v0.19.0)', () => {
