...
export type TraitKey = 'aggregated' | 'generated' | 'invariant' | 'knowledge' | 'localized';
...
// =============================================================================
// KIND ICONS (34) — Lucide icon names
// =============================================================================
...
export const TRAITS_ICONS: Record<string, IconDefinition> = {
  'aggregated': { web: 'calculator', terminal: '▪', description: 'Computed metrics and analytics' },
  'generated': { web: 'sparkles', terminal: '★', description: 'LLM-generated content output' },
