...
SET el.entity_key = 'booking-appointment',
    ...
    el.description = 'La Réservation pour vos projets QR Code.',
...
SET el.entity_key = 'qr-code-whatsapp',
    ...
    el.description = 'La WhatsApp QR Code pour vos projets QR Code.',
...
SET el.entity_key = 'qr-code-apple-music',
    ...
    el.description = 'L\'Apple Music QR Code pour vos projets QR Code.',
...
SET el.entity_key = 'qr-code-apple-maps',
    ...
    el.description = 'L\'Apple Maps QR Code pour vos projets QR Code.',
...
SET el.entity_key = 'qr-code-app-store',
    ...
    el.description = 'L\'App Store QR Code pour vos projets QR Code.',
...
SET el.entity_key = 'barcode-scanner',
    ...
    el.description = 'Le Code-barres Scanner pour vos projets QR Code.',
...
SET el.entity_key = 'menus-printed',
    ...
    el.description = 'L\'Menus Imprimés pour vos projets QR Code.',
...
SET el.entity_key = 'freelancers',
    ...
    el.description = 'Les Freelances pour vos projets QR Code.',
...
SET el.entity_key = 'apple',
    ...
    el.description = 'L\'Apple pour vos projets QR Code.',
