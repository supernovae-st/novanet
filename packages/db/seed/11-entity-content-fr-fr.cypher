...
SET el.entity_key = 'qr-code-with-text',
    ...
    el.definition = 'Solution QR Code AI pour la création et gestion de QR Code avec Texte.',
    el.purpose = 'Optimisez vos campagnes marketing avec QR Code avec Texte personnalisés.',
...
SET el.entity_key = 'qr-code-image-gallery',
    ...
    el.description = 'Galerie d\'images accessible par QR Code.',
...
SET el.entity_key = 'qr-code-social',
    ...
    el.description = 'Liens vers profils réseaux sociaux.',
...
SET el.entity_key = 'qr-code-soundcloud',
    ...
    el.description = 'Lien vers piste ou profil SoundCloud.',
...
SET el.entity_key = 'qr-code-paypal',
    ...
    el.description = 'Lien de paiement PayPal sécurisé.',
...
SET el.entity_key = 'msi-plessey',
    ...
    el.llm_context = 'UTILISER: pour discuter de MSI Plessey barcodes, entrepôt inventory barcodes, grocery store shelf labeling, or check-digit numeric codes. DECLENCHEURS: msi plessey, msi barcode, plessey barcode, inventory barcode, entrepôt barcode, shelf barcode. EXCLURE: Code 128 (modern), ITF-14 (shipping).',
    el.version = 1,
    el.created_at = datetime(),
    el.updated_at = datetime();
...
SET el.entity_key = 'device-detection',
    ...
    el.llm_context = 'UTILISER: pour discuter de device detection, OS tracking, browser detection, or mobile vs desktop analytics. DECLENCHEURS: device detection, os detection, browser detection, device type, mobile or desktop, what device, utilisateur agent. EXCLURE: geo-tracking (location), contextual routing (redirect).',
    el.version = 1,
    el.created_at = datetime(),
    el.updated_at = datetime();
...
SET el.entity_key = 'team-workspaces',
    ...
    el.llm_context = 'UTILISER: pour discuter de team collaboration, multi-utilisateur access, shared QR code management, or role-based permissions. DECLENCHEURS: team workspace, collaboration, multi-utilisateur, shared access, team members, roles, permissions, organization. EXCLURE: white-label (branding), api (integration).',
    el.version = 1,
    el.created_at = datetime(),
    el.updated_at = datetime();
...
SET el.entity_key = 'transportation',
    ...
    el.description = 'Solutions QR Code pour transport et mobilité.',
    ...
    el.llm_context = 'UTILISER: pour discuter de QR codes for airlines, transit, or transportation ticketing. DECLENCHEURS: airline qr, transit qr, transportation qr, boarding pass qr, train qr, bus qr. EXCLURE: logistics (entrepôt), manufacturing (production).',
    el.version = 1,
    el.created_at = datetime(),
    el.updated_at = datetime();
...
SET el.entity_key = 'logistics',
    ...
    el.llm_context = 'UTILISER: pour discuter de QR codes for logistics, shipping, or entrepôt management. DECLENCHEURS: logistics qr, shipping qr, entrepôt qr, delivery qr, supply chain qr, tracking qr. EXCLURE: manufacturing (production), retail (stores).',
    el.version = 1,
    el.created_at = datetime(),
    el.updated_at = datetime();
...
SET el.entity_key = 'marketing-agencies',
    ...
    el.description = 'Solutions QR Code pour agences marketing.',
...
SET el.entity_key = 'nonprofits',
    el.locale_key = 'fr-FR',
    el.curation_status = 'ai_generated',
    el.display_name = 'Associations',
    el.description = 'QR Codes pour associations : dons, bénévolat.',
    el.definition = 'Solutions QR Code spécialisées pour le secteur Associations.',
    el.purpose = 'Transformez votre activité Associations avec des QR Codes sur mesure.',
...
SET el.entity_key = 'developers',
    ...
    el.llm_context = 'UTILISER: pour discuter de developers, API integration, or programmatic QR code generation. DECLENCHEURS: developer qr, api utilisateur, programmer qr, integrator, coder qr, tech qr. EXCLURE: enterprise (organization), agencies (marketing).',
    el.version = 1,
    el.created_at = datetime(),
    el.updated_at = datetime();
...
SET el.entity_key = 'apple',
    ...
    el.description = 'Solutions QR Code pour l\'écosystème Apple.',
...
SET el.entity_key = 'soundcloud',
    ...
    el.description = 'Intégration QR Code pour SoundCloud.',
...
SET el.entity_key = 'google',
    ...
    el.description = 'Solutions QR Code pour Google Maps et Reviews.',
