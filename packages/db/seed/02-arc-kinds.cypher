...
// 120 ArcClass nodes + hierarchy + arc schema relations
// ═══════════════════════════════════════════════════════════════════════════════
...
ON CREATE SET
  ...
  ac_COMPILED_FROM.llm_context = 'USE: when tracing prompt artifact to source instruction for auditing. TRIGGERS: prompt source, instruction audit, template origin. NOT: for generated content (use HAS_GENERATED), for instruction editing (use PageInstruction). RELATES: PromptArtifact (source), PageInstruction/BlockInstruction (target).',
...
ON CREATE SET
  ...
  ac_GENERATED.llm_context = 'USE: when tracing which instruction produced which generated content. TRIGGERS: generation provenance, instruction audit, output source. NOT: for structure ownership (use HAS_GENERATED), for compiled prompts (use COMPILED_FROM). RELATES: PageInstruction/BlockInstruction (source), PageGenerated/BlockGenerated (target).',
...
ON CREATE SET
  ...
  ac_INCLUDES_STYLE.llm_context = 'USE: when loading style settings for instruction compilation. TRIGGERS: locale style, voice settings, tone configuration. NOT: for instruction content (use PageInstruction), for generated output (use HAS_GENERATED). RELATES: PageInstruction/BlockInstruction (source), Style (target, cross_realm).',
...
// ═══════════════════════════════════════════════════════════════════════════════
// Hierarchy: ArcFamily -[:HAS_ARC_CLASS]-> ArcClass (120)
// ═══════════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
// Facet: ArcClass -[:IN_FAMILY]-> ArcFamily (120)
// ═══════════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:FROM_CLASS]-> Class (137)
// ═══════════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:TO_CLASS]-> Class (137)
// ═══════════════════════════════════════════════════════════════════════════════
