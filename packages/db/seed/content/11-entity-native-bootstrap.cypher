...
SET en.display_name = 'Générateur de QR Code',
    ...
    en.status = 'active',
    en.entity_key = 'qr-code-generator',
    en.locale_key = 'fr-FR',
    en.locale = 'fr-FR',
    en.version = 1,
    en.provenance = '{"source":"seed","file":"11-entity-native-bootstrap.cypher"}',
...
// entity:qr-code@en-US (root entity)
...
// entity:qr-code-generator@en-US
...
// fr-FR links
MATCH (e:Entity {key: 'entity:qr-code'}), (en:EntityNative {key: 'entity:qr-code@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:custom-qr-code'}), (en:EntityNative {key: 'entity:custom-qr-code@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:qr-code-art'}), (en:EntityNative {key: 'entity:qr-code-art@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:dynamic-qr-code'}), (en:EntityNative {key: 'entity:dynamic-qr-code@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:static-qr-code'}), (en:EntityNative {key: 'entity:static-qr-code@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:smart-link'}), (en:EntityNative {key: 'entity:smart-link@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:landing-page'}), (en:EntityNative {key: 'entity:landing-page@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:barcode'}), (en:EntityNative {key: 'entity:barcode@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:qr-code-generator'}), (en:EntityNative {key: 'entity:qr-code-generator@fr-FR'})
MERGE (e)-[:HAS_NATIVE]->(en);

// en-US links
MATCH (e:Entity {key: 'entity:qr-code'}), (en:EntityNative {key: 'entity:qr-code@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:custom-qr-code'}), (en:EntityNative {key: 'entity:custom-qr-code@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:dynamic-qr-code'}), (en:EntityNative {key: 'entity:dynamic-qr-code@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:static-qr-code'}), (en:EntityNative {key: 'entity:static-qr-code@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:qr-code-generator'}), (en:EntityNative {key: 'entity:qr-code-generator@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:qr-code-art'}), (en:EntityNative {key: 'entity:qr-code-art@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:smart-link'}), (en:EntityNative {key: 'entity:smart-link@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:landing-page'}), (en:EntityNative {key: 'entity:landing-page@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);

MATCH (e:Entity {key: 'entity:barcode'}), (en:EntityNative {key: 'entity:barcode@en-US'})
MERGE (e)-[:HAS_NATIVE]->(en);
