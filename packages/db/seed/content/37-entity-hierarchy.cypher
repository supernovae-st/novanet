...
MATCH (parent:Entity {key: 'entity:qr-code-generator'})
MATCH (child:Entity)
WHERE child.key IN [
  'qr-code-instagram',
  'qr-code-facebook',
...
MATCH (parent:Entity {key: 'entity:create-qr-code'})
MATCH (child:Entity)
WHERE child.key IN [
  'customize-qr-code',
  'download-qr-code',
...
MATCH (parent:Entity {key: 'entity:smart-link'})
MATCH (child:Entity)
WHERE child.key IN [
  'short-link',
  'url-shortener',
...
MATCH (parent:Entity {key: 'entity:landing-page'})
MATCH (child:Entity)
WHERE child.key IN [
