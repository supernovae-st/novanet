...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-generator', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:dynamic-qr-code', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:static-qr-code', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-wifi', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-vcard', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-menu', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:smart-link', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:barcode', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:landing-page', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-instagram', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-facebook', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-youtube', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-pdf', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:qr-code-payment', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:create-qr-code', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:scan-qr-code', locale_key: 'fr-FR'})
SET en.benefits = [
...
MATCH (en:EntityNative {entity_key: 'entity:custom-qr-code', locale_key: 'fr-FR'})
SET en.benefits = [
