...
MATCH (parent:Entity {key: 'entity:qr-code'})
...
MATCH (parent:Entity {key: 'entity:barcode'})
MERGE (child)-[r:SEMANTIC_LINK {link_type: 'type_of'}]->(parent)
SET r.temperature = 0.95,
...
MATCH (parent:Entity {key: 'entity:custom-qr-code'})
...
MATCH (entity:Entity {key: 'entity:dynamic-qr-code'})
...
MATCH (entity:Entity {key: 'entity:api'})
MATCH (requirement:Entity {key: 'entity:api-documentation'})
WHERE EXISTS { MATCH (e:Entity {key: 'entity:api-documentation'}) }
MERGE (entity)-[r:SEMANTIC_LINK {link_type: 'requires'}]->(requirement)
SET r.temperature = 0.70,
...
MATCH (entity:Entity {key: 'entity:qr-code-with-logo'})
MATCH (feature:Entity {key: 'entity:custom-qr-code'})
...
MATCH (a:Entity {key: 'entity:dynamic-qr-code'})
MATCH (b:Entity {key: 'entity:static-qr-code'})
...
// QR code vs Barcode
MATCH (a:Entity {key: 'entity:qr-code'})
MATCH (b:Entity {key: 'entity:barcode'})
MERGE (a)-[r:SEMANTIC_LINK {link_type: 'contrasts'}]->(b)
SET r.temperature = 0.50,
...
MATCH (target:Entity {key: 'entity:qr-code'})
...
MATCH (action:Entity {key: 'entity:scan-qr-code'})
MATCH (target:Entity {key: 'entity:qr-code'})
MERGE (action)-[r:SEMANTIC_LINK {link_type: 'is_action_on'}]->(target)
SET r.temperature = 0.90,
...
MATCH (action:Entity {key: 'entity:customize-qr-code'})
MATCH (target:Entity {key: 'entity:qr-code'})
MERGE (action)-[r:SEMANTIC_LINK {link_type: 'is_action_on'}]->(target)
SET r.temperature = 0.90,
...
MATCH (action:Entity {key: 'entity:download-qr-code'})
MATCH (target:Entity {key: 'entity:qr-code'})
MERGE (action)-[r:SEMANTIC_LINK {link_type: 'is_action_on'}]->(target)
SET r.temperature = 0.90,
...
MATCH (action:Entity {key: 'entity:share-qr-code'})
MATCH (target:Entity {key: 'entity:qr-code'})
MERGE (action)-[r:SEMANTIC_LINK {link_type: 'is_action_on'}]->(target)
SET r.temperature = 0.90,
...
MATCH (action:Entity {key: 'entity:print-qr-code'})
MATCH (target:Entity {key: 'entity:qr-code'})
MERGE (action)-[r:SEMANTIC_LINK {link_type: 'is_action_on'}]->(target)
SET r.temperature = 0.90,
...
MATCH (whole:Entity {key: 'entity:custom-qr-code'})
...
MATCH (part:Entity {key: 'entity:qr-code-scanner'})
MATCH (whole:Entity {key: 'entity:scan-qr-code'})
MERGE (part)-[r:SEMANTIC_LINK {link_type: 'part_of'}]->(whole)
SET r.temperature = 0.85,
