...
ON CREATE SET
  ...
  pn.content = 'Assembled qr-code page for US market',
...
ON CREATE SET
  ...
  pn.content = 'Page qr-code assemblée pour le marché français',
...
ON CREATE SET
  ...
  pn.content = 'Página qr-code ensamblada para el mercado mexicano',
...
ON CREATE SET
  ...
  pn.content = 'QR-Code-Seite für den deutschen Markt',
