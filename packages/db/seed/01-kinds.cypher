...
ON CREATE SET
  ...
  k_Adaptation.knowledge_tier = 'technical',
...
ON CREATE SET
  ...
  k_AudienceSet.llm_context = 'Segment-specific audience behavior and preferences',
  k_AudienceSet.yaml_path = 'node-kinds/global/knowledge/audience-set.yaml',
  k_AudienceSet.properties = ['consumer_behavior', 'created_at', 'decision_makers', 'demographics', 'description', 'digital_behavior', 'display_name', 'llm_context', 'media_consumption', 'payment_preferences', 'purchasing_behavior', 'segment', 'trust_signals', 'updated_at'],
  k_AudienceSet.required_properties = ['created_at', 'description', 'display_name', 'llm_context', 'segment', 'updated_at'],
  k_AudienceSet.schema_hint = 'consumer_behavior, created_at (req), decision_makers, demographics, description (req), digital_behavior, display_name (req), llm_context (req), media_consumption, payment_preferences, purchasing_behavior, segment (req), trust_signals, updated_at (req)',
  k_AudienceSet.context_budget = 'medium',
  k_AudienceSet.knowledge_tier = 'semantic',
...
ON CREATE SET
  ...
  k_CultureSet.llm_context = 'Type-specific cultural knowledge and references',
  k_CultureSet.yaml_path = 'node-kinds/global/knowledge/culture-set.yaml',
  k_CultureSet.properties = ['business_calendar', 'celebrity_guidelines', 'core_values', 'created_at', 'culture_type', 'decision_factors', 'description', 'display_name', 'events', 'holidays', 'landmarks', 'llm_context', 'safe_celebrities', 'shared_knowledge', 'trust_factors', 'updated_at', 'vacation_periods'],
  k_CultureSet.required_properties = ['created_at', 'culture_type', 'description', 'display_name', 'llm_context', 'updated_at'],
  k_CultureSet.schema_hint = 'business_calendar, celebrity_guidelines, core_values, created_at (req), culture_type (req), decision_factors, description (req), display_name (req), events, holidays, landmarks, llm_context (req), safe_celebrities, shared_knowledge, trust_factors, updated_at (req), vacation_periods',
  k_CultureSet.context_budget = 'medium',
  k_CultureSet.knowledge_tier = 'semantic',
...
ON CREATE SET
  ...
  k_ExpressionSet.llm_context = 'Register-specific expressions, idioms, and phrases',
  k_ExpressionSet.yaml_path = 'node-kinds/global/knowledge/expression-set.yaml',
  k_ExpressionSet.properties = ['created_at', 'description', 'display_name', 'emphasis', 'expressions', 'idioms', 'llm_context', 'register', 'transitions', 'updated_at'],
  k_ExpressionSet.required_properties = ['created_at', 'description', 'display_name', 'expressions', 'llm_context', 'register', 'updated_at'],
  k_ExpressionSet.schema_hint = 'created_at (req), description (req), display_name (req), emphasis, expressions (req), idioms, llm_context (req), register (req), transitions, updated_at (req)',
  k_ExpressionSet.context_budget = 'medium',
  k_ExpressionSet.knowledge_tier = 'semantic',
...
ON CREATE SET
  ...
  k_Formatting.knowledge_tier = 'technical',
...
ON CREATE SET
  ...
  k_PatternSet.llm_context = 'Usage-specific content patterns and templates',
  k_PatternSet.yaml_path = 'node-kinds/global/knowledge/pattern-set.yaml',
  k_PatternSet.properties = ['avoid_patterns', 'created_at', 'description', 'display_name', 'llm_context', 'patterns', 'power_verbs', 'structures', 'updated_at', 'usage'],
  k_PatternSet.required_properties = ['created_at', 'description', 'display_name', 'llm_context', 'patterns', 'updated_at', 'usage'],
  k_PatternSet.schema_hint = 'avoid_patterns, created_at (req), description (req), display_name (req), llm_context (req), patterns (req), power_verbs, structures, updated_at (req), usage (req)',
  k_PatternSet.context_budget = 'medium',
  k_PatternSet.knowledge_tier = 'semantic',
...
ON CREATE SET
  ...
  k_Slugification.knowledge_tier = 'technical',
...
ON CREATE SET
  ...
  k_TabooSet.llm_context = 'Severity-specific taboos, constraints, and compliance rules',
  k_TabooSet.yaml_path = 'node-kinds/global/knowledge/taboo-set.yaml',
  k_TabooSet.properties = ['advertising_rules', 'created_at', 'cultural_sensitivities', 'description', 'display_name', 'forbidden_comparisons', 'forbidden_imagery', 'forbidden_topics', 'industry_specific', 'legal_requirements', 'llm_context', 'sensitive_topics', 'severity', 'updated_at'],
  k_TabooSet.required_properties = ['created_at', 'description', 'display_name', 'llm_context', 'severity', 'updated_at'],
  k_TabooSet.schema_hint = 'advertising_rules, created_at (req), cultural_sensitivities, description (req), display_name (req), forbidden_comparisons, forbidden_imagery, forbidden_topics, industry_specific, legal_requirements, llm_context (req), sensitive_topics, severity (req), updated_at (req)',
  k_TabooSet.context_budget = 'medium',
  k_TabooSet.knowledge_tier = 'semantic',
...
ON CREATE SET
  ...
  k_TermSet.llm_context = 'Domain-specific terminology and vocabulary',
  k_TermSet.yaml_path = 'node-kinds/global/knowledge/term-set.yaml',
  k_TermSet.properties = ['avoid_terms', 'created_at', 'description', 'display_name', 'domain', 'llm_context', 'preferred_terms', 'terms', 'updated_at', 'variants_by_context'],
  k_TermSet.required_properties = ['created_at', 'description', 'display_name', 'domain', 'llm_context', 'terms', 'updated_at'],
  k_TermSet.schema_hint = 'avoid_terms, created_at (req), description (req), display_name (req), domain (req), llm_context (req), preferred_terms, terms (req), updated_at (req), variants_by_context',
  k_TermSet.context_budget = 'medium',
  k_TermSet.knowledge_tier = 'semantic',
