...
// 182 ArcClass nodes + hierarchy + arc schema relations
//
// ADR References:
...
ON CREATE SET
  ...
  ac_HAS_METRICS.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_METRICS_OF.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_TARGETS_GEO.arc_property_info = '[{name: 'priority', type: 'string', required: true, enum: ['primary', 'secondary', 'tertiary']}, {name: 'target_engines', type: 'array', required: false}, {name: 'visibility_goal', type: 'float', required: false}]',
...
ON CREATE SET
  ...
  ac_TARGETS_KEYWORD.arc_property_info = '[{name: 'priority', type: 'string', required: true, enum: ['primary', 'secondary', 'tertiary']}, {name: 'strategy', type: 'string', required: false, enum: ['main_keyword', 'long_tail', 'semantic_variant', 'featured_snippet', 'voice_search']}, {name: 'target_position', type: 'integer', required: false}]',
...
ON CREATE SET
  ...
  ac_CONTAINS_TERM.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_HAS_KEYWORD.arc_property_info = '[{name: 'rank', type: 'string', required: true, enum: ['primary', 'secondary']}, {name: 'relevance', type: 'float', required: false, default: '1.0'}]',
...
ON CREATE SET
  ...
  ac_HAS_MARKET.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_HAS_TERMS.arc_property_info = '[{name: 'domain', type: 'string', required: true}]',
...
ON CREATE SET
  ...
  ac_MARKET_OF.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_TERMS_OF.arc_property_info = '[{name: 'domain', type: 'string', required: true}]',
...
ON CREATE SET
  ...
  ac_ACTS_ON.arc_property_info = '[{name: 'operation_type', type: 'string', required: false, enum: ['create', 'read', 'update', 'delete', 'scan', 'download', 'print', 'customize', 'track']}, {name: 'strength', type: 'float', required: false, default: '0.8'}, {name: 'temperature', type: 'float', required: false, default: '0.85'}]',
...
ON CREATE SET
  ...
  ac_ALTERNATIVE_TO.arc_property_info = '[{name: 'alternative_type', type: 'string', required: false, enum: ['equivalent', 'similar', 'fallback', 'upgrade', 'downgrade']}, {name: 'context', type: 'string', required: false}, {name: 'strength', type: 'float', required: false, default: '0.7'}, {name: 'temperature', type: 'float', required: false, default: '0.75'}]',
...
ON CREATE SET
  ...
  ac_APPLIES_TO.arc_property_info = '[{name: 'application_type', type: 'string', required: false, enum: ['use_case', 'domain', 'industry', 'scenario', 'context']}, {name: 'relevance', type: 'string', required: false, enum: ['primary', 'secondary', 'niche', 'experimental']}, {name: 'strength', type: 'float', required: false, default: '0.75'}, {name: 'temperature', type: 'float', required: false, default: '0.8'}]',
...
ON CREATE SET
  ...
  ac_COMPARES_A.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_COMPARES_B.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_COMPETES_WITH.arc_property_info = '[{name: 'competition_type', type: 'string', required: false, enum: ['direct', 'indirect', 'substitute', 'emerging']}, {name: 'market_segment', type: 'string', required: false}, {name: 'strength', type: 'float', required: false, default: '0.6'}, {name: 'temperature', type: 'float', required: false, default: '0.7'}]',
...
ON CREATE SET
  ...
  ac_CULTURALLY_SIMILAR.arc_property_info = '[{name: 'similarity_score', type: 'float', required: true}, {name: 'factors', type: 'json', required: false}]',
...
ON CREATE SET
  ...
  ac_CULTURE_REF_USED_BY.inverse_name = null,
...
ON CREATE SET
  ...
  ac_ENABLED_BY.arc_property_info = '[{name: 'enablement_type', type: 'string', required: false, enum: ['unlocks', 'enhances', 'permits', 'facilitates']}, {name: 'strength', type: 'float', required: false, default: '0.75'}, {name: 'temperature', type: 'float', required: false, default: '0.8'}]',
...
ON CREATE SET
  ...
  ac_ENABLES.arc_property_info = '[{name: 'enablement_type', type: 'string', required: false, enum: ['unlocks', 'enhances', 'permits', 'facilitates']}, {name: 'strength', type: 'float', required: false, default: '0.75'}, {name: 'temperature', type: 'float', required: false, default: '0.8'}]',
...
ON CREATE SET
  ...
  ac_ENHANCED_BY.arc_property_info = '[{name: 'enhancement_type', type: 'string', required: false, enum: ['adds', 'improves', 'extends', 'optimizes', 'secures', 'tracks']}, {name: 'strength', type: 'float', required: false, default: '0.75'}, {name: 'temperature', type: 'float', required: false, default: '0.8'}]',
...
ON CREATE SET
  ...
  ac_ENHANCES.arc_property_info = '[{name: 'enhancement_type', type: 'string', required: false, enum: ['adds', 'improves', 'extends', 'optimizes', 'secures', 'tracks']}, {name: 'strength', type: 'float', required: false, default: '0.75'}, {name: 'temperature', type: 'float', required: false, default: '0.8'}]',
...
ON CREATE SET
  ...
  ac_EXPRESSES.arc_property_info = '[{name: 'match_score', type: 'float', required: false}, {name: 'role', type: 'string', required: false, enum: ['primary', 'secondary', 'long_tail']}]',
...
ON CREATE SET
  ...
  ac_EXPRESSION_USED_BY.inverse_name = null,
...
ON CREATE SET
  ...
  ac_FILLS_SLOT.arc_property_info = '[{name: 'is_control', type: 'string', required: false}, {name: 'traffic_allocation', type: 'string', required: false}, {name: 'variant_id', type: 'string', required: false}]',
...
ON CREATE SET
  ...
  ac_FOR_CHANNEL.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_FOR_MARKET.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_HAS_APPLICATION.arc_property_info = '[{name: 'application_type', type: 'string', required: false, enum: ['use_case', 'domain', 'industry', 'scenario', 'context']}, {name: 'relevance', type: 'string', required: false, enum: ['primary', 'secondary', 'niche', 'experimental']}, {name: 'strength', type: 'float', required: false, default: '0.75'}, {name: 'temperature', type: 'float', required: false, default: '0.8'}]',
...
ON CREATE SET
  ...
  ac_HAS_INTERNAL_LINK.arc_property_info = '[{name: 'anchor_text', type: 'string', required: false}, {name: 'nofollow', type: 'boolean', required: false}, {name: 'position', type: 'integer', required: false}]',
...
ON CREATE SET
  ...
  ac_HAS_TYPE.arc_property_info = '[{name: 'strength', type: 'float', required: false, default: '0.85'}, {name: 'taxonomy_level', type: 'string', required: false, enum: ['genus', 'species', 'subspecies', 'instance']}, {name: 'temperature', type: 'float', required: false, default: '0.9'}]',
...
ON CREATE SET
  ...
  ac_HAS_VARIANT.arc_property_info = '[{name: 'strength', type: 'float', required: false, default: '0.8'}, {name: 'temperature', type: 'float', required: false, default: '0.85'}, {name: 'variant_type', type: 'string', required: false, enum: ['version', 'flavor', 'edition', 'specialization', 'customization']}]',
...
ON CREATE SET
  ...
  ac_INCLUDED_IN.arc_property_info = '[{name: 'containment_type', type: 'string', required: false, enum: ['part', 'component', 'element', 'member', 'feature']}, {name: 'strength', type: 'float', required: false, default: '0.9'}, {name: 'temperature', type: 'float', required: false, default: '0.95'}]',
...
ON CREATE SET
  ...
  ac_INCLUDES.arc_property_info = '[{name: 'containment_type', type: 'string', required: false, enum: ['part', 'component', 'element', 'member', 'feature']}, {name: 'strength', type: 'float', required: false, default: '0.9'}, {name: 'temperature', type: 'float', required: false, default: '0.95'}]',
...
ON CREATE SET
  ...
  ac_INSPIRED_BY_REGION.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_KEYWORD_OF.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_LINKS_TO.arc_property_info = '[{name: 'anchor_type', type: 'string', required: false, enum: ['exact_match', 'partial_match', 'branded', 'generic']}, {name: 'nofollow', type: 'boolean', required: false, default: 'false'}, {name: 'pr_weight', type: 'float', required: false, default: '0.5'}, {name: 'strength', type: 'integer', required: false, default: '1'}, {name: 'via_blocks', type: 'array', required: false}]',
...
ON CREATE SET
  ...
  ac_MENTIONS.arc_property_info = '[{name: 'position', type: 'integer', required: true}, {name: 'purpose', type: 'string', required: true, enum: ['inject', 'link']}, {name: 'ref_type', type: 'string', required: true, enum: ['entity', 'page', 'term', 'expr', 'seo', 'audience', 'brand', 'prompt', 'project']}]',
...
ON CREATE SET
  ...
  ac_MENTIONS_BRAND.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_MONITORS_GEO.arc_property_info = '[{name: 'alert_threshold', type: 'int', required: false}, {name: 'priority', type: 'string', required: false, enum: ['primary', 'secondary', 'tertiary']}]',
...
ON CREATE SET
  ...
  ac_OPERATED_BY.arc_property_info = '[{name: 'operation_type', type: 'string', required: false, enum: ['create', 'read', 'update', 'delete', 'scan', 'download', 'print', 'customize', 'track']}, {name: 'strength', type: 'float', required: false, default: '0.8'}, {name: 'temperature', type: 'float', required: false, default: '0.85'}]',
...
ON CREATE SET
  ...
  ac_PATTERN_USED_BY.inverse_name = null,
...
ON CREATE SET
  ...
  ac_READS.arc_property_info = '[{name: 'read_type', type: 'string', required: false, enum: ['scan', 'decode', 'parse', 'extract', 'verify']}, {name: 'strength', type: 'float', required: false, default: '0.9'}, {name: 'temperature', type: 'float', required: false, default: '0.85'}]',
...
ON CREATE SET
  ...
  ac_READ_BY.arc_property_info = '[{name: 'read_type', type: 'string', required: false, enum: ['scan', 'decode', 'parse', 'extract', 'verify']}, {name: 'strength', type: 'float', required: false, default: '0.9'}, {name: 'temperature', type: 'float', required: false, default: '0.85'}]',
...
ON CREATE SET
  ...
  ac_REFERENCED_BY.arc_property_info = '[{name: 'purpose', type: 'string', required: true, enum: ['inject', 'link']}, {name: 'count', type: 'integer', required: false, default: '1'}]',
...
ON CREATE SET
  ...
  ac_REFERENCES_ENTITY.arc_property_info = '[{name: 'context', type: 'string', required: false}, {name: 'syntax', type: 'string', required: false}]',
...
ON CREATE SET
  ...
  ac_REFERENCES_PAGE.arc_property_info = '[{name: 'context', type: 'string', required: false}, {name: 'syntax', type: 'string', required: false}]',
...
ON CREATE SET
  ...
  ac_REQUIRED_BY.arc_property_info = '[{name: 'condition', type: 'string', required: false}, {name: 'dependency_type', type: 'string', required: false, enum: ['hard', 'soft', 'optional', 'conditional']}, {name: 'strength', type: 'float', required: false, default: '0.9'}, {name: 'temperature', type: 'float', required: false, default: '0.95'}]',
...
ON CREATE SET
  ...
  ac_REQUIRES.arc_property_info = '[{name: 'condition', type: 'string', required: false}, {name: 'dependency_type', type: 'string', required: false, enum: ['hard', 'soft', 'optional', 'conditional']}, {name: 'strength', type: 'float', required: false, default: '0.9'}, {name: 'temperature', type: 'float', required: false, default: '0.95'}]',
...
ON CREATE SET
  ...
  ac_SEMANTIC_LINK.arc_property_info = '[{name: 'temperature', type: 'string', required: false}, {name: 'type', type: 'string', required: false}]',
...
ON CREATE SET
  ...
  ac_SEO_CLUSTER_OF.arc_property_info = '[{name: 'cluster_role', type: 'string', required: false, enum: ['supporting', 'comparison', 'tutorial', 'case_study', 'faq']}, {name: 'link_priority', type: 'integer', required: false, default: '1'}]',
...
ON CREATE SET
  ...
  ac_SIMILAR_TO.arc_property_info = '[{name: 'similarity_dimensions', type: 'json', required: false}, {name: 'similarity_type', type: 'string', required: false, enum: ['functional', 'structural', 'semantic', 'visual', 'behavioral']}, {name: 'strength', type: 'float', required: false, default: '0.65'}, {name: 'temperature', type: 'float', required: false, default: '0.7'}]',
...
ON CREATE SET
  ...
  ac_SLUGIFIES.inverse_name = null,
...
ON CREATE SET
  ...
  ac_TARGETS.arc_property_info = '[{name: 'rank', type: 'string', required: true, enum: ['primary', 'secondary', 'tertiary']}, {name: 'created_at', type: 'datetime', required: false}, {name: 'is_slug_source', type: 'boolean', required: false, default: 'false'}, {name: 'target_position', type: 'int', required: false}]',
...
ON CREATE SET
  ...
  ac_TARGETS_PERSONA.arc_property_info = null,
...
MERGE (ac_TERM_USED_BY:Schema:ArcClass {key: 'TERM_USED_BY'})
ON CREATE SET
  ac_TERM_USED_BY.display_name = 'Term Used By',
  ac_TERM_USED_BY.llm_context = 'USE: when finding which EntityNative nodes use a specific term. TRIGGERS: term usage, vocabulary analysis, term consistency check. NOT: term containers (use CONTAINS_TERM), term definitions. RELATES: Term (source), EntityNative (target), USES_TERM (forward arc). EXAMPLE: Find all entities using "QR Code" term across locales.',
  ac_TERM_USED_BY.family = 'semantic',
  ac_TERM_USED_BY.scope = 'cross_realm',
  ac_TERM_USED_BY.cardinality = 'many_to_many',
  ac_TERM_USED_BY.is_self_referential = false,
  ac_TERM_USED_BY.inverse_name = null,
  ac_TERM_USED_BY.arc_properties = ['purpose', 'temperature', 'semantic_field'],
  ac_TERM_USED_BY.arc_property_info = '[{name: 'purpose', type: 'string', required: false, enum: ['primary', 'secondary', 'contextual', 'avoid']}, {name: 'semantic_field', type: 'string', required: false, enum: ['domain', 'action', 'benefit', 'feature', 'comparison', 'technical']}, {name: 'temperature', type: 'float', required: false, default: '0.8'}]',
  ac_TERM_USED_BY.cypher_pattern = '(Term)-[:TERM_USED_BY]->(EntityNative)',
  ac_TERM_USED_BY.temperature_threshold = 0.5,
  ac_TERM_USED_BY.created_at = datetime()
ON MATCH SET
  ac_TERM_USED_BY.display_name = 'Term Used By',
  ac_TERM_USED_BY.llm_context = 'USE: when finding which EntityNative nodes use a specific term. TRIGGERS: term usage, vocabulary analysis, term consistency check. NOT: term containers (use CONTAINS_TERM), term definitions. RELATES: Term (source), EntityNative (target), USES_TERM (forward arc). EXAMPLE: Find all entities using "QR Code" term across locales.',
  ac_TERM_USED_BY.family = 'semantic',
  ...
  ac_TERM_USED_BY.cypher_pattern = '(Term)-[:TERM_USED_BY]->(EntityNative)',
  ac_TERM_USED_BY.temperature_threshold = 0.5,
  ac_TERM_USED_BY.updated_at = datetime();
...
ON CREATE SET
  ...
  ac_TYPE_OF.arc_property_info = '[{name: 'strength', type: 'float', required: false, default: '0.85'}, {name: 'taxonomy_level', type: 'string', required: false, enum: ['genus', 'species', 'subspecies', 'instance']}, {name: 'temperature', type: 'float', required: false, default: '0.9'}]',
...
ON CREATE SET
  ...
  ac_USED_BY.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_USES_ENTITY.arc_property_info = '[{name: 'purpose', type: 'string', required: false, enum: ['primary', 'secondary', 'contextual']}, {name: 'temperature', type: 'float', required: false, default: '1.0'}]',
...
MERGE (ac_USES_TERM:Schema:ArcClass {key: 'USES_TERM'})
ON CREATE SET
  ac_USES_TERM.display_name = 'Uses Term',
  ac_USES_TERM.llm_context = 'USE: when loading locale-specific vocabulary for EntityNative generation. TRIGGERS: uses term, vocabulary, glossary, domain terms, native phrasing. NOT: all locale terms (use HAS_TERMS for bulk), entity hierarchy (use HAS_CHILD). RELATES: EntityNative (source), Term (target), TERM_USED_BY (inverse), semantic_field: domain/action/benefit/feature/comparison/technical. EXAMPLE: "qr-code@fr-FR" USES_TERM {purpose: "primary", semantic_field: "action"} "creer_qr_code"',
  ac_USES_TERM.family = 'semantic',
  ac_USES_TERM.scope = 'cross_realm',
  ac_USES_TERM.cardinality = 'many_to_many',
  ac_USES_TERM.is_self_referential = false,
  ac_USES_TERM.inverse_name = 'TERM_USED_BY',
  ac_USES_TERM.arc_properties = ['purpose', 'temperature', 'semantic_field'],
  ac_USES_TERM.arc_property_info = '[{name: 'purpose', type: 'string', required: false, enum: ['primary', 'secondary', 'contextual', 'avoid']}, {name: 'semantic_field', type: 'string', required: false, enum: ['domain', 'action', 'benefit', 'feature', 'comparison', 'technical']}, {name: 'temperature', type: 'float', required: false, default: '0.8'}]',
  ac_USES_TERM.cypher_pattern = '(EntityNative)-[:USES_TERM]->(Term)',
  ac_USES_TERM.temperature_threshold = 0.3,
  ac_USES_TERM.created_at = datetime()
ON MATCH SET
  ac_USES_TERM.display_name = 'Uses Term',
  ac_USES_TERM.llm_context = 'USE: when loading locale-specific vocabulary for EntityNative generation. TRIGGERS: uses term, vocabulary, glossary, domain terms, native phrasing. NOT: all locale terms (use HAS_TERMS for bulk), entity hierarchy (use HAS_CHILD). RELATES: EntityNative (source), Term (target), TERM_USED_BY (inverse), semantic_field: domain/action/benefit/feature/comparison/technical. EXAMPLE: "qr-code@fr-FR" USES_TERM {purpose: "primary", semantic_field: "action"} "creer_qr_code"',
  ac_USES_TERM.family = 'semantic',
  ...
  ac_USES_TERM.cypher_pattern = '(EntityNative)-[:USES_TERM]->(Term)',
  ac_USES_TERM.temperature_threshold = 0.3,
  ac_USES_TERM.updated_at = datetime();
...
ON CREATE SET
  ...
  ac_USE_CASE_FOR.arc_property_info = null,
...
ON CREATE SET
  ...
  ac_VARIANT_OF.arc_property_info = '[{name: 'strength', type: 'float', required: false, default: '0.8'}, {name: 'temperature', type: 'float', required: false, default: '0.85'}, {name: 'variant_type', type: 'string', required: false, enum: ['version', 'flavor', 'edition', 'specialization', 'customization']}]',
...
// ═══════════════════════════════════════════════════════════════════════════════
// Hierarchy: ArcFamily -[:HAS_ARC_CLASS]-> ArcClass (182)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (af:ArcFamily {key: 'semantic'}), (ac:ArcClass {key: 'TERM_USED_BY'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
MATCH (af:ArcFamily {key: 'semantic'}), (ac:ArcClass {key: 'USES_TERM'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Facet: ArcClass -[:IN_FAMILY]-> ArcFamily (182)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'TERM_USED_BY'}), (af:ArcFamily {key: 'semantic'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
MATCH (ac:ArcClass {key: 'USES_TERM'}), (af:ArcFamily {key: 'semantic'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:FROM_CLASS]-> Class (209)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'TERM_USED_BY'}), (c:Class {label: 'Term'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'USES_TERM'}), (c:Class {label: 'EntityNative'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:TO_CLASS]-> Class (214)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'TERM_USED_BY'}), (c:Class {label: 'EntityNative'})
MERGE (ac)-[:TO_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'USES_TERM'}), (c:Class {label: 'Term'})
MERGE (ac)-[:TO_CLASS]->(c);
