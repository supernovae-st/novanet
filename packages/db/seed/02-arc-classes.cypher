...
// 159 ArcClass nodes + hierarchy + arc schema relations
//
// ADR References:
...
ON CREATE SET
  ...
  ac_HAS_PRIMARY_POPULATION.content = '',
...
ON CREATE SET
  ...
  ac_IN_CULTURAL_SUBREALM.content = '',
...
// CLUSTERS_UNDER (ADR-031)
MERGE (ac_CLUSTERS_UNDER:Schema:ArcClass {key: 'CLUSTERS_UNDER'})
ON CREATE SET
  ac_CLUSTERS_UNDER.display_name = 'Clusters Under',
  ac_CLUSTERS_UNDER.content = '',
  ac_CLUSTERS_UNDER.family = 'mining',
  ac_CLUSTERS_UNDER.scope = 'intra_realm',
  ac_CLUSTERS_UNDER.cardinality = 'many_to_one',
  ac_CLUSTERS_UNDER.is_self_referential = false,
  ac_CLUSTERS_UNDER.inverse_name = 'CLUSTER_OF',
  ac_CLUSTERS_UNDER.arc_properties = ['source_tool', 'clustered_at'],
  ac_CLUSTERS_UNDER.arc_property_info = '[{name: \'clustered_at\', type: \'datetime\', required: false}, {name: \'source_tool\', type: \'string\', required: false, enum: [\'ahrefs\', \'semrush\', \'dataforseo\', \'manual\']}]',
  ac_CLUSTERS_UNDER.cypher_pattern = '(SEOKeyword)-[:CLUSTERS_UNDER]->(SEOKeyword)',
  ac_CLUSTERS_UNDER.temperature_threshold = null,
  ac_CLUSTERS_UNDER.node_class = 'arc_class',
  ac_CLUSTERS_UNDER.created_by = 'seed:schema',
  ac_CLUSTERS_UNDER.created_at = datetime()
ON MATCH SET
  ac_CLUSTERS_UNDER.display_name = 'Clusters Under',
  ac_CLUSTERS_UNDER.content = '',
  ac_CLUSTERS_UNDER.family = 'mining',
  ...
  ac_CLUSTERS_UNDER.temperature_threshold = null,
  ac_CLUSTERS_UNDER.node_class = 'arc_class',
  ac_CLUSTERS_UNDER.updated_at = datetime();

// CLUSTER_OF (ADR-031)
MERGE (ac_CLUSTER_OF:Schema:ArcClass {key: 'CLUSTER_OF'})
ON CREATE SET
  ac_CLUSTER_OF.display_name = 'Cluster Of',
  ac_CLUSTER_OF.content = '',
  ac_CLUSTER_OF.family = 'mining',
  ac_CLUSTER_OF.scope = 'intra_realm',
  ac_CLUSTER_OF.cardinality = 'one_to_many',
  ac_CLUSTER_OF.is_self_referential = false,
  ac_CLUSTER_OF.inverse_name = 'CLUSTERS_UNDER',
  ac_CLUSTER_OF.arc_properties = [],
  ac_CLUSTER_OF.arc_property_info = null,
  ac_CLUSTER_OF.cypher_pattern = '(SEOKeyword)-[:CLUSTER_OF]->(SEOKeyword)',
...
ON CREATE SET
  ...
  ac_KEYWORD_TARGETED_BY.content = '',
  ...
  ac_KEYWORD_TARGETED_BY.cypher_pattern = '(SEOKeyword)-[:KEYWORD_TARGETED_BY]->(EntityNative, Page, Block)',
...
ON CREATE SET
  ...
  ac_BELONGS_TO_PROJECT_NATIVE.content = '',
...
ON CREATE SET
  ...
  ac_CONTAINS_AUDIENCE_TRAIT.content = '',
...
ON CREATE SET
  ...
  ac_CONTAINS_CULTURE_REF.content = '',
...
ON CREATE SET
  ...
  ac_CONTAINS_EXPRESSION.content = '',
...
ON CREATE SET
  ...
  ac_CONTAINS_SEO_KEYWORD.content = '',
...
ON CREATE SET
  ...
  ac_CULTURE_REF_USED_BY.content = '',
...
MERGE (ac_ENTITY_REFERENCED_IN:Schema:ArcClass {key: 'ENTITY_REFERENCED_IN'})
ON CREATE SET
  ac_ENTITY_REFERENCED_IN.display_name = 'Entity Referenced In',
  ac_ENTITY_REFERENCED_IN.content = '',
  ac_ENTITY_REFERENCED_IN.family = 'semantic',
  ac_ENTITY_REFERENCED_IN.scope = 'intra_realm',
  ac_ENTITY_REFERENCED_IN.cardinality = 'many_to_many',
  ac_ENTITY_REFERENCED_IN.is_self_referential = false,
  ac_ENTITY_REFERENCED_IN.inverse_name = 'REFERENCES_ENTITY',
  ac_ENTITY_REFERENCED_IN.arc_properties = [],
  ac_ENTITY_REFERENCED_IN.arc_property_info = null,
  ac_ENTITY_REFERENCED_IN.cypher_pattern = '(Entity)-[:ENTITY_REFERENCED_IN]->(BlockInstruction)',
  ac_ENTITY_REFERENCED_IN.temperature_threshold = null,
  ac_ENTITY_REFERENCED_IN.node_class = 'arc_class',
  ac_ENTITY_REFERENCED_IN.created_by = 'seed:schema',
  ac_ENTITY_REFERENCED_IN.created_at = datetime()
ON MATCH SET
  ac_ENTITY_REFERENCED_IN.display_name = 'Entity Referenced In',
  ac_ENTITY_REFERENCED_IN.content = '',
  ac_ENTITY_REFERENCED_IN.family = 'semantic',
...
MERGE (ac_LINKED_FROM:Schema:ArcClass {key: 'LINKED_FROM'})
ON CREATE SET
  ac_LINKED_FROM.display_name = 'Linked From',
  ac_LINKED_FROM.content = '',
  ac_LINKED_FROM.family = 'semantic',
  ac_LINKED_FROM.scope = 'intra_realm',
  ac_LINKED_FROM.cardinality = 'many_to_many',
  ac_LINKED_FROM.is_self_referential = false,
  ac_LINKED_FROM.inverse_name = 'LINKS_TO',
  ac_LINKED_FROM.arc_properties = [],
  ac_LINKED_FROM.arc_property_info = null,
  ac_LINKED_FROM.cypher_pattern = '(Page)-[:LINKED_FROM]->(Page)',
  ac_LINKED_FROM.temperature_threshold = null,
  ac_LINKED_FROM.node_class = 'arc_class',
  ac_LINKED_FROM.created_by = 'seed:schema',
  ac_LINKED_FROM.created_at = datetime()
ON MATCH SET
  ac_LINKED_FROM.display_name = 'Linked From',
  ac_LINKED_FROM.content = '',
  ac_LINKED_FROM.family = 'semantic',
  ...
  ac_LINKED_FROM.temperature_threshold = null,
  ac_LINKED_FROM.node_class = 'arc_class',
  ac_LINKED_FROM.updated_at = datetime();
...
ON CREATE SET
  ...
  ac_LINKS_TO.inverse_name = 'LINKED_FROM',
  ac_LINKS_TO.arc_properties = ['anchor_type', 'context', 'priority', 'nofollow', 'source_blocks'],
  ac_LINKS_TO.arc_property_info = '[{name: \'anchor_type\', type: \'string\', required: true, enum: [\'entity_name\', \'custom_text\', \'cta_button\'], default: \'entity_name\'}, {name: \'context\', type: \'string\', required: false}, {name: \'nofollow\', type: \'boolean\', required: false, default: \'false\'}, {name: \'priority\', type: \'float\', required: false, default: \'0.5\'}, {name: \'source_blocks\', type: \'string[]\', required: false}]',
  ac_LINKS_TO.cypher_pattern = '(Page)-[:LINKS_TO]->(Page)',
  ac_LINKS_TO.temperature_threshold = null,
  ac_LINKS_TO.node_class = 'arc_class',
  ac_LINKS_TO.created_by = 'seed:schema',
...
MERGE (ac_PAGE_REFERENCED_IN:Schema:ArcClass {key: 'PAGE_REFERENCED_IN'})
ON CREATE SET
  ac_PAGE_REFERENCED_IN.display_name = 'Page Referenced In',
  ac_PAGE_REFERENCED_IN.content = '',
  ac_PAGE_REFERENCED_IN.family = 'semantic',
  ac_PAGE_REFERENCED_IN.scope = 'intra_realm',
  ac_PAGE_REFERENCED_IN.cardinality = 'many_to_many',
  ac_PAGE_REFERENCED_IN.is_self_referential = false,
  ac_PAGE_REFERENCED_IN.inverse_name = 'REFERENCES_PAGE',
  ac_PAGE_REFERENCED_IN.arc_properties = [],
  ac_PAGE_REFERENCED_IN.arc_property_info = null,
  ac_PAGE_REFERENCED_IN.cypher_pattern = '(Page)-[:PAGE_REFERENCED_IN]->(BlockInstruction)',
  ac_PAGE_REFERENCED_IN.temperature_threshold = null,
  ac_PAGE_REFERENCED_IN.node_class = 'arc_class',
  ac_PAGE_REFERENCED_IN.created_by = 'seed:schema',
  ac_PAGE_REFERENCED_IN.created_at = datetime()
ON MATCH SET
  ac_PAGE_REFERENCED_IN.display_name = 'Page Referenced In',
  ac_PAGE_REFERENCED_IN.content = '',
  ac_PAGE_REFERENCED_IN.family = 'semantic',
...
ON CREATE SET
  ...
  ac_REFERENCES_ENTITY.inverse_name = 'ENTITY_REFERENCED_IN',
  ac_REFERENCES_ENTITY.arc_properties = ['reference_type', 'count'],
  ac_REFERENCES_ENTITY.arc_property_info = '[{name: \'reference_type\', type: \'string\', required: true, enum: [\'inject\', \'mention\', \'compare\'], default: \'inject\'}, {name: \'count\', type: \'integer\', required: false, default: \'1\'}]',
  ac_REFERENCES_ENTITY.cypher_pattern = '(BlockInstruction)-[:REFERENCES_ENTITY]->(Entity)',
  ac_REFERENCES_ENTITY.temperature_threshold = null,
  ac_REFERENCES_ENTITY.node_class = 'arc_class',
  ac_REFERENCES_ENTITY.created_by = 'seed:schema',
...
ON CREATE SET
  ...
  ac_REFERENCES_PAGE.inverse_name = 'PAGE_REFERENCED_IN',
  ac_REFERENCES_PAGE.arc_properties = ['link_purpose'],
  ac_REFERENCES_PAGE.arc_property_info = '[{name: \'link_purpose\', type: \'string\', required: true, enum: [\'navigation\', \'conversion\', \'related\', \'comparison\'], default: \'navigation\'}]',
  ac_REFERENCES_PAGE.cypher_pattern = '(BlockInstruction)-[:REFERENCES_PAGE]->(Page)',
  ac_REFERENCES_PAGE.temperature_threshold = null,
  ac_REFERENCES_PAGE.node_class = 'arc_class',
  ac_REFERENCES_PAGE.created_by = 'seed:schema',
...
ON CREATE SET
  ...
  ac_SEMANTICALLY_EQUIVALENT.content = '',
...
MERGE (ac_USED_BY_BLOCK:Schema:ArcClass {key: 'USED_BY_BLOCK'})
ON CREATE SET
  ac_USED_BY_BLOCK.display_name = 'Used By Block',
  ac_USED_BY_BLOCK.content = '',
  ac_USED_BY_BLOCK.family = 'semantic',
  ac_USED_BY_BLOCK.scope = 'intra_realm',
  ac_USED_BY_BLOCK.cardinality = 'many_to_many',
  ac_USED_BY_BLOCK.is_self_referential = false,
  ac_USED_BY_BLOCK.inverse_name = 'USES_ENTITY',
  ac_USED_BY_BLOCK.arc_properties = [],
  ac_USED_BY_BLOCK.arc_property_info = null,
  ac_USED_BY_BLOCK.cypher_pattern = '(Entity)-[:USED_BY_BLOCK]->(Block)',
  ac_USED_BY_BLOCK.temperature_threshold = null,
  ac_USED_BY_BLOCK.node_class = 'arc_class',
  ac_USED_BY_BLOCK.created_by = 'seed:schema',
  ac_USED_BY_BLOCK.created_at = datetime()
ON MATCH SET
  ac_USED_BY_BLOCK.display_name = 'Used By Block',
  ac_USED_BY_BLOCK.content = '',
  ac_USED_BY_BLOCK.family = 'semantic',
...
ON CREATE SET
  ...
  ac_USES_ENTITY.inverse_name = 'USED_BY_BLOCK',
  ac_USES_ENTITY.arc_properties = ['role', 'injection_type'],
  ac_USES_ENTITY.arc_property_info = '[{name: \'role\', type: \'string\', required: true, enum: [\'primary\', \'supporting\', \'contextual\'], default: \'supporting\'}, {name: \'injection_type\', type: \'string\', required: false, enum: [\'content\', \'link\', \'comparison\'], default: \'content\'}]',
  ac_USES_ENTITY.cypher_pattern = '(Block)-[:USES_ENTITY]->(Entity)',
  ac_USES_ENTITY.temperature_threshold = null,
  ac_USES_ENTITY.node_class = 'arc_class',
  ac_USES_ENTITY.created_by = 'seed:schema',
...
// ═══════════════════════════════════════════════════════════════════════════════
// Hierarchy: ArcFamily -[:HAS_ARC_CLASS]-> ArcClass (159)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (af:ArcFamily {key: 'mining'}), (ac:ArcClass {key: 'CLUSTERS_UNDER'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);

MATCH (af:ArcFamily {key: 'mining'}), (ac:ArcClass {key: 'CLUSTER_OF'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
MATCH (af:ArcFamily {key: 'semantic'}), (ac:ArcClass {key: 'ENTITY_REFERENCED_IN'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
MATCH (af:ArcFamily {key: 'semantic'}), (ac:ArcClass {key: 'LINKED_FROM'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
MATCH (af:ArcFamily {key: 'semantic'}), (ac:ArcClass {key: 'PAGE_REFERENCED_IN'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
MATCH (af:ArcFamily {key: 'semantic'}), (ac:ArcClass {key: 'USED_BY_BLOCK'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Facet: ArcClass -[:IN_FAMILY]-> ArcFamily (159)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'CLUSTERS_UNDER'}), (af:ArcFamily {key: 'mining'})
MERGE (ac)-[:IN_FAMILY]->(af);

MATCH (ac:ArcClass {key: 'CLUSTER_OF'}), (af:ArcFamily {key: 'mining'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
MATCH (ac:ArcClass {key: 'ENTITY_REFERENCED_IN'}), (af:ArcFamily {key: 'semantic'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
MATCH (ac:ArcClass {key: 'LINKED_FROM'}), (af:ArcFamily {key: 'semantic'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
MATCH (ac:ArcClass {key: 'PAGE_REFERENCED_IN'}), (af:ArcFamily {key: 'semantic'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
MATCH (ac:ArcClass {key: 'USED_BY_BLOCK'}), (af:ArcFamily {key: 'semantic'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:FROM_CLASS]-> Class (190)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'CLUSTERS_UNDER'}), (c:Class {label: 'SEOKeyword'})
MERGE (ac)-[:FROM_CLASS]->(c);

MATCH (ac:ArcClass {key: 'CLUSTER_OF'}), (c:Class {label: 'SEOKeyword'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'ENTITY_REFERENCED_IN'}), (c:Class {label: 'Entity'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'LINKED_FROM'}), (c:Class {label: 'Page'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'PAGE_REFERENCED_IN'}), (c:Class {label: 'Page'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'USED_BY_BLOCK'}), (c:Class {label: 'Entity'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:TO_CLASS]-> Class (191)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'KEYWORD_TARGETED_BY'}), (c:Class {label: 'EntityNative'})
MERGE (ac)-[:TO_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'ENTITY_REFERENCED_IN'}), (c:Class {label: 'BlockInstruction'})
MERGE (ac)-[:TO_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'PAGE_REFERENCED_IN'}), (c:Class {label: 'BlockInstruction'})
MERGE (ac)-[:TO_CLASS]->(c);
...
MATCH (ac:ArcClass {key: 'USED_BY_BLOCK'}), (c:Class {label: 'Block'})
MERGE (ac)-[:TO_CLASS]->(c);
