...
// 170 ArcClass nodes + hierarchy + arc schema relations
// ═══════════════════════════════════════════════════════════════════════════════
...
ON CREATE SET
  ac_HAS_KEYWORD.display_name = 'Has Keyword',
  ac_HAS_KEYWORD.llm_context = 'USE: when identifying core SEO keywords semantically associated with an entity. TRIGGERS: entity keywords, entity SEO, primary keywords, semantic keywords, entity targeting. NOT: page keyword targeting (use TARGETS_KEYWORD), keyword metrics (use HAS_METRICS). RELATES: Entity (source), SEOKeyword (target), rank (primary/secondary/tertiary).',
  ac_HAS_KEYWORD.family = 'semantic',
  ac_HAS_KEYWORD.scope = 'cross_realm',
  ac_HAS_KEYWORD.cardinality = 'many_to_many',
  ac_HAS_KEYWORD.is_self_referential = false,
  ac_HAS_KEYWORD.inverse_name = 'KEYWORD_OF',
  ac_HAS_KEYWORD.arc_properties = ['rank', 'intent_match'],
  ac_HAS_KEYWORD.cypher_pattern = '(Entity)-[:HAS_KEYWORD]->(SEOKeyword)',
  ac_HAS_KEYWORD.temperature_threshold = 0.5,
  ac_HAS_KEYWORD.created_at = datetime()
ON MATCH SET
...
ON CREATE SET
  ...
  ac_KEYWORD_OF.cardinality = 'many_to_many',
...
// ═══════════════════════════════════════════════════════════════════════════════
// Hierarchy: ArcFamily -[:HAS_ARC_CLASS]-> ArcClass (170)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (af:ArcFamily {key: 'semantic'}), (ac:ArcClass {key: 'HAS_KEYWORD'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Facet: ArcClass -[:IN_FAMILY]-> ArcFamily (170)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'HAS_KEYWORD'}), (af:ArcFamily {key: 'semantic'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:FROM_CLASS]-> Class (194)
// ═══════════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:TO_CLASS]-> Class (199)
// ═══════════════════════════════════════════════════════════════════════════════
