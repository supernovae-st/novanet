...
ON CREATE SET
  ...
  ac_DERIVED_SLUG_FROM.llm_context = 'USE: when auditing slug derivation decisions for SEO. TRIGGERS: slug audit, keyword derivation, SEO slug, URL generation audit. NOT: page linking (use LINKS_TO), keyword targeting (use TARGETS), slug validation (use SLUGIFIED_BY). RELATES: BlockNative:head-seo-meta (source), SEOKeyword (target), slug_form (copied value), audit trail. CRITICAL: The slug is COPIED from SEOKeyword.slug_form, NOT generated by LLM.',
  ...
  ac_DERIVED_SLUG_FROM.cypher_pattern = '(BlockNative)-[:DERIVED_SLUG_FROM]->(SEOKeyword)',
