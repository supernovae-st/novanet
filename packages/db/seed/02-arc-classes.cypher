...
// 148 ArcClass nodes + hierarchy + arc schema relations
//
// ADR References:
...
MERGE (ac_ANCHORS:Schema:ArcClass {key: 'ANCHORS'})
ON CREATE SET
  ac_ANCHORS.display_name = 'Anchors',
  ac_ANCHORS.llm_context = 'USE: when finding which entities a page anchors to for context assembly. TRIGGERS: "page entities", "page topic", "canonical entity", "primary entity", "spreading activation". NOT: entity usage within blocks (use REFERENCES), entity mentions (use USES_ENTITY). RELATES: Page (source), Entity (target), ANCHOR_OF (inverse). ROLES: - focus (exactly 1 per Page): The primary semantic identity of the page (like old REPRESENTS) - support (0-N): Entities that provide context or enhance the focus - reference (0-N): Entities mentioned for completeness - compare (0-N): Entities being compared or contrasted with focus WEIGHT: Higher weight = load earlier in token-constrained context. NOTE: Page is created AFTER Entity exists. Page owns the URL slug (ADR-030).',
  ac_ANCHORS.family = 'semantic',
  ac_ANCHORS.scope = 'intra_realm',
  ac_ANCHORS.cardinality = 'many_to_many',
  ac_ANCHORS.is_self_referential = false,
  ac_ANCHORS.inverse_name = 'ANCHOR_OF',
  ac_ANCHORS.arc_properties = ['weight', 'role'],
  ac_ANCHORS.arc_property_info = '[{name: \'role\', type: \'string\', required: true, enum: [\'focus\', \'support\', \'reference\', \'compare\'], default: \'support\'}, {name: \'weight\', type: \'float\', required: true, default: \'0.6\'}]',
  ac_ANCHORS.cypher_pattern = '(Page)-[:ANCHORS]->(Entity)',
  ac_ANCHORS.temperature_threshold = null,
  ac_ANCHORS.node_class = 'arc_class',
  ac_ANCHORS.created_by = 'seed:schema',
  ac_ANCHORS.created_at = datetime()
ON MATCH SET
  ac_ANCHORS.display_name = 'Anchors',
  ac_ANCHORS.llm_context = 'USE: when finding which entities a page anchors to for context assembly. TRIGGERS: "page entities", "page topic", "canonical entity", "primary entity", "spreading activation". NOT: entity usage within blocks (use REFERENCES), entity mentions (use USES_ENTITY). RELATES: Page (source), Entity (target), ANCHOR_OF (inverse). ROLES: - focus (exactly 1 per Page): The primary semantic identity of the page (like old REPRESENTS) - support (0-N): Entities that provide context or enhance the focus - reference (0-N): Entities mentioned for completeness - compare (0-N): Entities being compared or contrasted with focus WEIGHT: Higher weight = load earlier in token-constrained context. NOTE: Page is created AFTER Entity exists. Page owns the URL slug (ADR-030).',
  ac_ANCHORS.family = 'semantic',
  ...
  ac_ANCHORS.temperature_threshold = null,
  ac_ANCHORS.node_class = 'arc_class',
  ac_ANCHORS.updated_at = datetime();
...
// ═══════════════════════════════════════════════════════════════════════════════
// Hierarchy: ArcFamily -[:HAS_ARC_CLASS]-> ArcClass (148)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (af:ArcFamily {key: 'semantic'}), (ac:ArcClass {key: 'ANCHORS'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Facet: ArcClass -[:IN_FAMILY]-> ArcFamily (148)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'ANCHORS'}), (af:ArcFamily {key: 'semantic'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:FROM_CLASS]-> Class (176)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'ANCHORS'}), (c:Class {label: 'Page'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:TO_CLASS]-> Class (175)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'ANCHORS'}), (c:Class {label: 'Entity'})
MERGE (ac)-[:TO_CLASS]->(c);
