...
// 156 ArcClass nodes + hierarchy + arc schema relations
// ═══════════════════════════════════════════════════════════════════════════════
...
MERGE (ac_CLASSIFIES:Schema:ArcClass {key: 'CLASSIFIES'})
ON CREATE SET
  ac_CLASSIFIES.display_name = 'Classifies',
  ac_CLASSIFIES.llm_context = 'USE: when finding all Locales in an economic classification. TRIGGERS: "income group locales", "lending category members", "economic classification". NOT: for finding a Locale\'s classification (use HAS_INCOME_LEVEL or HAS_LENDING_TYPE). RELATES: IncomeGroup/LendingCategory (source), Locale (target), HAS_INCOME_LEVEL/HAS_LENDING_TYPE (inverse).',
  ac_CLASSIFIES.family = 'localization',
  ac_CLASSIFIES.scope = 'intra_realm',
  ac_CLASSIFIES.cardinality = 'one_to_many',
  ac_CLASSIFIES.is_self_referential = false,
  ac_CLASSIFIES.inverse_name = null,
  ac_CLASSIFIES.arc_properties = [],
  ac_CLASSIFIES.cypher_pattern = '(IncomeGroup, LendingCategory)-[:CLASSIFIES]->(Locale)',
  ac_CLASSIFIES.temperature_threshold = null,
  ac_CLASSIFIES.created_at = datetime()
ON MATCH SET
  ac_CLASSIFIES.display_name = 'Classifies',
  ac_CLASSIFIES.llm_context = 'USE: when finding all Locales in an economic classification. TRIGGERS: "income group locales", "lending category members", "economic classification". NOT: for finding a Locale\'s classification (use HAS_INCOME_LEVEL or HAS_LENDING_TYPE). RELATES: IncomeGroup/LendingCategory (source), Locale (target), HAS_INCOME_LEVEL/HAS_LENDING_TYPE (inverse).',
  ac_CLASSIFIES.family = 'localization',
  ...
  ac_CLASSIFIES.cypher_pattern = '(IncomeGroup, LendingCategory)-[:CLASSIFIES]->(Locale)',
  ac_CLASSIFIES.temperature_threshold = null,
  ac_CLASSIFIES.updated_at = datetime();
...
// ═══════════════════════════════════════════════════════════════════════════════
// Hierarchy: ArcFamily -[:HAS_ARC_CLASS]-> ArcClass (156)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (af:ArcFamily {key: 'localization'}), (ac:ArcClass {key: 'CLASSIFIES'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
MATCH (af:ArcFamily {key: 'ownership'}), (ac:ArcClass {key: 'BELONGS_TO'})
MERGE (af)-[:HAS_ARC_CLASS]->(ac);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Facet: ArcClass -[:IN_FAMILY]-> ArcFamily (156)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'CLASSIFIES'}), (af:ArcFamily {key: 'localization'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
MATCH (ac:ArcClass {key: 'BELONGS_TO'}), (af:ArcFamily {key: 'ownership'})
MERGE (ac)-[:IN_FAMILY]->(af);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:FROM_CLASS]-> Class (179)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'CLASSIFIES'}), (c:Class {label: 'IncomeGroup'})
MERGE (ac)-[:FROM_CLASS]->(c);

MATCH (ac:ArcClass {key: 'CLASSIFIES'}), (c:Class {label: 'LendingCategory'})
MERGE (ac)-[:FROM_CLASS]->(c);
...
// ═══════════════════════════════════════════════════════════════════════════════
// Arc Schema: ArcClass -[:TO_CLASS]-> Class (186)
// ═══════════════════════════════════════════════════════════════════════════════
...
MATCH (ac:ArcClass {key: 'CLASSIFIES'}), (c:Class {label: 'Locale'})
MERGE (ac)-[:TO_CLASS]->(c);
