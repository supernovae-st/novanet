...
MERGE (cr:CultureRef {key: 'pakikisama-harmony@fil-PH'})
SET cr.locale = 'fil-PH',
    ...
    cr.description = 'Maintaining smooth interpersonal relationships and group harmony is paramount',
...
MERGE (cr:CultureRef {key: 'hiya-sense-of-shame@fil-PH'})
SET cr.locale = 'fil-PH',
    ...
    cr.description = 'Deep concern for social acceptance and avoiding embarrassment or losing face',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@fil-PH'})
...
SET cr.locale = 'fil-PH',
    ...
    cr.description = 'Strong sense of reciprocity and obligation to return favors',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@fil-PH'})
...
SET cr.locale = 'fil-PH',
    ...
    cr.description = 'Community helping each other, especially in times of need',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@fil-PH'})
...
MERGE (cr:CultureRef {key: 'family-first-values@fil-PH'})
SET cr.locale = 'fil-PH',
    ...
    cr.description = 'Family is the center of Filipino life; decisions consider family impact',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@fil-PH'})
...
MERGE (cr:CultureRef {key: 'respect-for-elders-po-opo@fil-PH'})
SET cr.locale = 'fil-PH',
    ...
    cr.description = 'Use of honorifics and deference to older or senior individuals',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@fil-PH'})
...
MERGE (cr:CultureRef {key: 'hospitality-mabuhay-spirit@fil-PH'})
SET cr.locale = 'fil-PH',
    ...
    cr.description = 'Welcoming guests warmly is a core cultural value',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@fil-PH'})
...
MERGE (t:Taboo {key: 'public-confrontation@fil-PH'})
SET t.locale = 'fil-PH',
    ...
    t.description = 'Causes loss of face (hiya) and damages relationships permanently',
...
MERGE (t:Taboo {key: 'refusing-hospitality@fil-PH'})
SET t.locale = 'fil-PH',
    ...
    t.description = 'Declining food or gifts is seen as rejecting the host\'s generosity',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@fil-PH'})
...
MERGE (t:Taboo {key: 'loud-or-aggressive-behavior@fil-PH'})
SET t.locale = 'fil-PH',
    ...
    t.description = 'Filipinos avoid raising voices and showing anger publicly',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@fil-PH'})
...
MERGE (t:Taboo {key: 'rushing-decisions@fil-PH'})
SET t.locale = 'fil-PH',
    ...
    t.description = 'Relationships take time to build; hasty decisions are seen as disrespectful',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@fil-PH'})
...
MERGE (t:Taboo {key: 'disrespecting-elders@fil-PH'})
SET t.locale = 'fil-PH',
    ...
    t.description = 'Age hierarchy is fundamental; ignoring it is deeply offensive',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@fil-PH'})
...
MERGE (at:AudienceTrait {key: 'mobile-first-consumers@fil-PH'})
SET at.locale = 'fil-PH',
    at.text = 'Mobile-first consumers',
    at.description = 'Philippines has one of highest social media usage rates globally',
...
MERGE (at:AudienceTrait {key: 'ofw-influence@fil-PH'})
SET at.locale = 'fil-PH',
    at.text = 'OFW influence',
    at.description = 'Overseas Filipino Workers shape consumption patterns and aspirations',
...
MERGE (at:AudienceTrait {key: 'celebrity-endorsements@fil-PH'})
SET at.locale = 'fil-PH',
    at.text = 'Celebrity endorsements',
    at.description = 'High trust in celebrity and influencer recommendations',
...
MERGE (e:Expression {key: 'mabuhay@fil-PH'})
SET e.locale = 'fil-PH',
    e.text = 'Mabuhay!',
    e.register = 'formal',
    e.context = 'Traditional welcome greeting',
    e.display_name = 'Mabuhay!',
    e.description = 'Traditional welcome greeting',
...
MERGE (e:Expression {key: 'salamat-po@fil-PH'})
SET e.locale = 'fil-PH',
    e.text = 'Salamat po',
    e.register = 'polite',
    e.context = 'Thank you (with respect marker)',
    e.display_name = 'Salamat po',
    e.description = 'Thank you (with respect marker)',
    e.created_at = datetime(),
    e.updated_at = datetime()
WITH e
MATCH (es:ExpressionSet {key: 'expression-set:greetings@fil-PH'})
...
MERGE (p:Pattern {key: 'cta-sumali-na-sa-produc@fil-PH'})
SET p.locale = 'fil-PH',
    ...
    p.description = 'Join {product} and experience the difference!',
...
MERGE (p:Pattern {key: 'social-proof-pinagkakatiwalaan-ng@fil-PH'})
SET p.locale = 'fil-PH',
    ...
    p.description = 'Trusted by millions of Filipino families',
    p.created_at = datetime(),
    p.updated_at = datetime()
WITH p
MATCH (ps:PatternSet {key: 'pattern-set:cta@fil-PH'})
...
MERGE (cr:CultureRef {key: 'theravada-buddhism@lo-LA'})
SET cr.locale = 'lo-LA',
    ...
    cr.description = 'Buddhism permeates daily life; monks and temples hold central reverence',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
...
MERGE (cr:CultureRef {key: 'harmony-and-non-confrontation@lo-LA'})
SET cr.locale = 'lo-LA',
    ...
    cr.description = 'Preserving face and avoiding conflict is paramount in all interactions',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@lo-LA'})
...
MERGE (cr:CultureRef {key: 'sabaidee-spirit@lo-LA'})
SET cr.locale = 'lo-LA',
    ...
    cr.description = 'The universal greeting reflects cultural warmth and well-wishing',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@lo-LA'})
...
MERGE (cr:CultureRef {key: 'respect-for-hierarchy@lo-LA'})
SET cr.locale = 'lo-LA',
    ...
    cr.description = 'Age and social status determine appropriate behavior and language',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@lo-LA'})
...
MERGE (cr:CultureRef {key: 'modesty@lo-LA'})
SET cr.locale = 'lo-LA',
    cr.text = 'Modesty',
    cr.importance = 'high',
    ...
    cr.description = 'Physical and behavioral modesty is expected in public',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@lo-LA'})
...
MERGE (cr:CultureRef {key: 'community-support@lo-LA'})
SET cr.locale = 'lo-LA',
    ...
    cr.description = 'Supporting local businesses and community reflects goodwill',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@lo-LA'})
...
MERGE (t:Taboo {key: 'touching-heads@lo-LA'})
SET t.locale = 'lo-LA',
    ...
    t.description = 'The head is considered sacred and the highest part of the body',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
...
MERGE (t:Taboo {key: 'pointing-with-feet@lo-LA'})
SET t.locale = 'lo-LA',
    ...
    t.description = 'Feet are considered the lowest and dirtiest part of the body',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@lo-LA'})
...
MERGE (t:Taboo {key: 'public-displays-of-affection@lo-LA'})
SET t.locale = 'lo-LA',
    ...
    t.description = 'Physical intimacy in public is considered inappropriate',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@lo-LA'})
...
MERGE (t:Taboo {key: 'raising-voice-or-arguing@lo-LA'})
SET t.locale = 'lo-LA',
    ...
    t.description = 'Causes loss of face and disrupts harmony',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@lo-LA'})
...
MERGE (t:Taboo {key: 'disrespecting-monks@lo-LA'})
SET t.locale = 'lo-LA',
    ...
    t.description = 'Monks are highly revered; women must not touch them',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@lo-LA'})
...
MERGE (t:Taboo {key: 'rushing-decisions@lo-LA'})
SET t.locale = 'lo-LA',
    t.text = 'Rushing decisions',
    t.severity = 'medium',
    ...
    t.display_name = 'Rushing decisions',
    t.description = 'Patience is valued; haste can seem disrespectful',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@lo-LA'})
...
MERGE (at:AudienceTrait {key: 'mobile-penetration-growing@lo-LA'})
SET at.locale = 'lo-LA',
    at.text = 'Mobile penetration growing',
    at.description = 'Increasing smartphone adoption, especially among youth',
...
MERGE (at:AudienceTrait {key: 'traditional-values@lo-LA'})
SET at.locale = 'lo-LA',
    at.text = 'Traditional values',
    at.description = 'Strong adherence to Buddhist and traditional practices',
...
MERGE (at:AudienceTrait {key: 'face-conscious@lo-LA'})
SET at.locale = 'lo-LA',
    at.text = 'Face-conscious',
    at.description = 'Social standing and reputation highly important',
...
MERGE (e:Expression {key: 'khop-jai@lo-LA'})
SET e.locale = 'lo-LA',
...
MERGE (p:Pattern {key: 'cta-product@lo-LA'})
SET p.locale = 'lo-LA',
    p.text = 'ເຂົ້າຮ່ວມ {product} ມື້ນີ້',
    p.type = 'cta',
    p.translation = 'Join {product} today',
    p.display_name = 'cta pattern',
    p.description = 'Join {product} today',
    p.created_at = datetime(),
    p.updated_at = datetime()
WITH p
...
MERGE (cr:CultureRef {key: 'lord-jagannath-devotion@or-IN'})
SET cr.locale = 'or-IN',
    ...
    cr.description = 'Lord Jagannath holds central significance in Odia life and culture',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
...
MERGE (cr:CultureRef {key: 'temple-heritage@or-IN'})
SET cr.locale = 'or-IN',
    ...
    cr.description = 'Odisha\'s temples are central to cultural identity and daily practice',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@or-IN'})
...
MERGE (cr:CultureRef {key: 'odissi-classical-arts@or-IN'})
SET cr.locale = 'or-IN',
    ...
    cr.description = 'Odissi dance originated in temples; represents regional pride',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@or-IN'})
...
MERGE (cr:CultureRef {key: 'dayakari-politeness@or-IN'})
SET cr.locale = 'or-IN',
    ...
    cr.description = 'Respect and politeness are fundamental to Odia interactions',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@or-IN'})
...
MERGE (cr:CultureRef {key: 'folk-culture-preservation@or-IN'})
SET cr.locale = 'or-IN',
    ...
    cr.description = 'Active efforts to preserve indigenous heritage against Western influence',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@or-IN'})
...
MERGE (cr:CultureRef {key: 'festival-traditions@or-IN'})
SET cr.locale = 'or-IN',
    ...
    cr.description = 'Major festivals like Rath Yatra, Nuakhai, Pousa Purnima are central',
    cr.created_at = datetime(),
    cr.updated_at = datetime()
WITH cr
MATCH (cs:CultureSet {key: 'culture-set:values@or-IN'})
...
MERGE (t:Taboo {key: 'disrespecting-lord-jagannath@or-IN'})
SET t.locale = 'or-IN',
    ...
    t.description = 'Jagannath is the heart of Odia identity; any disrespect is deeply offensive',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
...
MERGE (t:Taboo {key: 'temple-photography-without-permission@or-IN'})
SET t.locale = 'or-IN',
    ...
    t.description = 'Sacred spaces require permission and respect',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@or-IN'})
...
MERGE (t:Taboo {key: 'western-cultural-imposition@or-IN'})
SET t.locale = 'or-IN',
    ...
    t.description = 'Sensitivity about preserving indigenous culture from external influences',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@or-IN'})
...
MERGE (t:Taboo {key: 'impolite-language@or-IN'})
SET t.locale = 'or-IN',
    ...
    t.description = 'Politeness markers are expected in commercial and social interactions',
    t.created_at = datetime(),
    t.updated_at = datetime()
WITH t
MATCH (ts:TabooSet {key: 'taboo-set:avoid@or-IN'})
...
MERGE (at:AudienceTrait {key: 'regional-pride@or-IN'})
SET at.locale = 'or-IN',
    at.text = 'Regional pride',
    at.description = 'Strong identification with Odia heritage and Odisha state',
...
MERGE (at:AudienceTrait {key: 'festival-oriented@or-IN'})
SET at.locale = 'or-IN',
    at.text = 'Festival-oriented',
    at.description = 'Consumer behavior strongly tied to festival calendar',
...
MERGE (at:AudienceTrait {key: 'spiritually-connected@or-IN'})
SET at.locale = 'or-IN',
    at.text = 'Spiritually connected',
    at.description = 'Daily life intertwined with religious practices',
...
MERGE (e:Expression {key: 'dhanyabad@or-IN'})
SET e.locale = 'or-IN',
...
MERGE (e:Expression {key: 'jai-jagannath@or-IN'})
SET e.locale = 'or-IN',
    ...
    e.description = 'Victory to Lord Jagannath - common blessing',
    e.created_at = datetime(),
    e.updated_at = datetime()
WITH e
MATCH (es:ExpressionSet {key: 'expression-set:greetings@or-IN'})
...
MERGE (p:Pattern {key: 'cta-product@or-IN'})
SET p.locale = 'or-IN',
...
MERGE (p:Pattern {key: 'greeting@or-IN'})
SET p.locale = 'or-IN',
    p.text = 'ନମସ୍କାର! ସ୍ୱାଗତ',
    p.type = 'greeting',
    p.translation = 'Greetings! Welcome',
    p.display_name = 'greeting pattern',
    p.description = 'Greetings! Welcome',
    p.created_at = datetime(),
    p.updated_at = datetime()
WITH p
MATCH (ps:PatternSet {key: 'pattern-set:cta@or-IN'})
