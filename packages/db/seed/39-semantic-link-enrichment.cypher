...
MERGE (child)-[r:SEMANTIC_LINK {type: 'type_of'}]->(parent)
...
MERGE (tool)-[r:SEMANTIC_LINK {type: 'includes'}]->(included)
...
MERGE (parent)-[r:SEMANTIC_LINK {type: 'includes'}]->(feature)
SET r.temperature = 0.85,
...
MERGE (entity)-[r:SEMANTIC_LINK {type: 'requires'}]->(requirement)
...
MERGE (feature)-[r:SEMANTIC_LINK {type: 'exhibits'}]->(entity)
...
MERGE (a)-[r:SEMANTIC_LINK {type: 'contrasts'}]->(b)
...
MERGE (action)-[r:SEMANTIC_LINK {type: 'is_action_on'}]->(target)
...
MERGE (part)-[r:SEMANTIC_LINK {type: 'part_of'}]->(whole)
SET r.temperature = 0.85,
