    ...
    cat << EOF
{
  "hookSpecificOutput": {
    ...
    "additionalContext": "Documentation file edited. Ensure version ($VERSION) and counts (60 nodes, 90 arcs, 2 realms, 9 layers) are consistent. Run 'pnpm doc:audit' to verify."
  }
}
EOF
    ;;
