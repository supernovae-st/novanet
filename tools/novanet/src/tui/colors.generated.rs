    ...
    pub fn color(trait_key: &str, mode: ColorMode) -> Color {
        match mode {
            ColorMode::TrueColor => match trait_key {
                "authored" => super::hex_to_color(AUTHORED_HEX),
                "defined" => super::hex_to_color(DEFINED_HEX),
                "generated" => super::hex_to_color(GENERATED_HEX),
                "imported" => super::hex_to_color(IMPORTED_HEX),
                "retrieved" => super::hex_to_color(RETRIEVED_HEX),
                _ => Color::White,
            },
