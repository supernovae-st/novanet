...
pub fn tips(locale: NexusLocale) -> &'static [&'static str] {
    match locale {
        ...
        NexusLocale::Fr => &[
            "Knowledge = INPUT (savoir) - Localized = OUTPUT (généré)",
            "Les Layers définissent CE QUE fait un nœud, les Traits définissent COMMENT il se comporte avec la locale",
            "Les nœuds Content/Generated ont des parents invariants (Entity→EntityContent, Page→PageGenerated)",
            "Génération, PAS traduction : Knowledge + Structure -> Contenu natif",
            "Le realm Shared est en LECTURE SEULE - tout le contenu métier vit dans Org",
            "Saut rapide : gi=invariant, gl=localized, gk=knowledge, gg=generated, ga=aggregated",
            "Les nœuds Knowledge n'existent QUE là où ils sont nécessaires (fr-FR: 20K Terms, sw-KE: 500)",
            "Familles d'arcs : ownership, localization, semantic, generation, mining",
            "Invariant = structure (bordure pleine), Localized = sortie (bordure pointillée)",
...
pub fn intro_page2(locale: NexusLocale) -> &'static [&'static str] {
    match locale {
        NexusLocale::En => &[
            ...
            "✓  RIGHT:  Entity (invariant) → Generate → Content (locale-native)",
            "",
            "The LLM doesn't translate - it generates natively",
            "using Knowledge Atoms (Terms, Expressions, Patterns)",
        ...
        NexusLocale::Fr => &[
            ...
            "✓  JUSTE :  Entity (invariant) → Générer → Content (natif locale)",
            "",
            "Le LLM ne traduit pas - il génère nativement",
            "en utilisant les Knowledge Atoms (Terms, Expressions, Patterns)",
...
pub fn intro_page3(locale: NexusLocale) -> &'static [&'static str] {
    match locale {
        ...
        NexusLocale::Fr => &[
            "LA STRUCTURE DU GRAPHE (v11.7)",
            "",
            "60 types de nœuds organisés par :",
            "  • Realm (OÙ) : shared (39) | org (21)",
            "  • Layer (QUOI) : 10 couches fonctionnelles",
            "  • Trait (COMMENT) : invariant | localized | knowledge | generated | aggregated",
            "",
...
static TUTORIAL_STEPS_EN: [TutorialStepI18n; 5] = [
    ...
    TutorialStepI18n {
        ...
        description: "Traits define HOW a node behaves with locale: invariant (structure), localized (output), knowledge (input), generated, aggregated.",
        tasks: &[
...
static TUTORIAL_STEPS_FR: [TutorialStepI18n; 5] = [
    ...
    TutorialStepI18n {
        ...
        description: "Les Traits définissent COMMENT un nœud se comporte avec la locale : invariant (structure), localized (sortie), knowledge (entrée), generated, aggregated.",
        tasks: &[
    ...
    GlossaryCategoryI18n {
        ...
        concepts: &[
            ...
            GlossaryConceptI18n {
                ...
                full_desc: "Nodes that store locale-specific content. Examples: EntityContent, ProjectContent. One instance per locale, linked to invariant parent.",
            },
            GlossaryConceptI18n {
                name: "Knowledge",
            ...
            GlossaryConceptI18n {
                ...
                full_desc: "Content produced by LLM generation. PageGenerated, BlockGenerated, OutputArtifact. Created from invariant + knowledge inputs.",
            },
            GlossaryConceptI18n {
                name: "Aggregated",
                short_desc: "Computed metrics (thin dotted)",
                full_desc: "Nodes containing computed/aggregated data. GEOMetrics, SEOKeywordMetrics. Derived from mining operations, not LLM generation.",
            },
        ],
    },
    GlossaryCategoryI18n {
...
static GLOSSARY_FR: [GlossaryCategoryI18n; 4] = [
    GlossaryCategoryI18n {
        ...
        concepts: &[
            ...
            GlossaryConceptI18n {
                name: "Org",
                short_desc: "Contenu organisation (21 nœuds)",
    ...
    GlossaryCategoryI18n {
        ...
        concepts: &[
            ...
            GlossaryConceptI18n {
                ...
                full_desc: "Nœuds qui stockent le contenu spécifique à la locale. Exemples : EntityContent, ProjectContent. Une instance par locale, liée au parent invariant.",
            },
            GlossaryConceptI18n {
                name: "Knowledge",
            ...
            GlossaryConceptI18n {
                ...
                full_desc: "Contenu produit par la génération LLM. PageGenerated, BlockGenerated, OutputArtifact. Créé à partir des entrées invariant + knowledge.",
            },
            GlossaryConceptI18n {
                name: "Aggregated",
                short_desc: "Métriques calculées (pointillé fin)",
                full_desc: "Nœuds contenant des données calculées/agrégées. GEOMetrics, SEOKeywordMetrics. Dérivés des opérations de mining, pas de la génération LLM.",
            },
        ],
    },
    GlossaryCategoryI18n {
...
static QUIZ_EN: [QuizQuestionI18n; 15] = [
    QuizQuestionI18n {
        ...
        options: &["Global and Local", "Shared and Org", "Public and Private", "Core and Edge"],
        correct: 1,
        explanation: "Shared (universal, read-only) and Org (organization-specific).",
    },
    QuizQuestionI18n {
        question: "How many node types are in NovaNet v11.7?",
        options: &["45", "60", "75", "90"],
        correct: 1,
        explanation: "60 nodes: 39 in Shared realm + 21 in Org realm.",
    },
    QuizQuestionI18n {
        question: "What does the 'invariant' trait mean?",
        options: &["Changes per locale", "Structure that doesn't change", "Generated by LLM", "Computed metrics"],
        correct: 1,
        explanation: "Invariant nodes define structure and don't change with locale.",
    },
    QuizQuestionI18n {
        question: "Which trait do EntityContent and ProjectContent have?",
        options: &["Invariant", "Localized", "Knowledge", "Generated"],
        correct: 1,
        explanation: "Localized nodes store locale-specific content for invariant parents.",
    },
    QuizQuestionI18n {
        question: "What is NovaNet's core philosophy?",
        options: &["Translation at scale", "Native generation per locale", "Machine translation", "Manual localization"],
        correct: 1,
    ...
    QuizQuestionI18n {
        ...
        options: &["create, read, update, delete, query", "ownership, localization, semantic, generation, mining", "parent, child, sibling, cousin, ancestor", "input, output, transform, validate, store"],
        correct: 1,
        explanation: "Arc families: ownership, localization, semantic, generation, mining.",
    },
    QuizQuestionI18n {
        question: "What does 'cross_realm' arc scope mean?",
        options: &["Arc within same realm", "Arc between different realms", "Arc to external system", "Arc to database"],
        correct: 1,
    ...
    QuizQuestionI18n {
        ...
        options: &["Entity, Page, Block", "PageGenerated, BlockGenerated", "Term, Expression, Pattern", "Locale, Region, Country"],
        correct: 1,
        explanation: "Generated trait marks LLM output: PageGenerated, BlockGenerated, OutputArtifact.",
    },
    QuizQuestionI18n {
        question: "What is the 'aggregated' trait for?",
        options: &["Structure nodes", "LLM-generated content", "Computed metrics", "Locale content"],
        correct: 2,
        explanation: "Aggregated nodes contain computed data: GEOMetrics, SEOKeywordMetrics.",
    },
    QuizQuestionI18n {
    ...
    QuizQuestionI18n {
        ...
        options: &["Database-first design", "Cypher is source of truth for display", "REST API pattern", "GraphQL approach"],
        correct: 1,
    ...
    QuizQuestionI18n {
        ...
        options: &["org/semantic", "shared/knowledge", "shared/config", "org/config"],
        correct: 2,
    ...
    QuizQuestionI18n {
        ...
        options: &["Translation budget", "Knowledge exists only where needed", "Different alphabet", "Population size"],
        correct: 1,
...
static QUIZ_FR: [QuizQuestionI18n; 15] = [
    QuizQuestionI18n {
        ...
        options: &["Global et Local", "Shared et Org", "Public et Privé", "Core et Edge"],
        correct: 1,
        explanation: "Shared (universel, lecture seule) et Org (spécifique à l'organisation).",
    },
    QuizQuestionI18n {
        question: "Combien de types de nœuds dans NovaNet v11.7 ?",
        options: &["45", "60", "75", "90"],
        correct: 1,
        explanation: "60 nœuds : 39 dans Shared + 21 dans Org.",
    },
    QuizQuestionI18n {
        question: "Que signifie le trait 'invariant' ?",
        options: &["Change par locale", "Structure qui ne change pas", "Généré par LLM", "Métriques calculées"],
        correct: 1,
        explanation: "Les nœuds invariants définissent la structure et ne changent pas avec la locale.",
    },
    QuizQuestionI18n {
        question: "Quel trait ont EntityContent et ProjectContent ?",
        options: &["Invariant", "Localized", "Knowledge", "Generated"],
        correct: 1,
        explanation: "Les nœuds Localized stockent le contenu spécifique à la locale pour les parents invariants.",
    },
    QuizQuestionI18n {
        question: "Quelle est la philosophie centrale de NovaNet ?",
        options: &["Traduction à grande échelle", "Génération native par locale", "Traduction automatique", "Localisation manuelle"],
        correct: 1,
    ...
    QuizQuestionI18n {
        ...
        options: &["Arc dans le même realm", "Arc entre différents realms", "Arc vers système externe", "Arc vers base de données"],
        correct: 1,
    ...
    QuizQuestionI18n {
        question: "À quoi sert le trait 'aggregated' ?",
        options: &["Nœuds de structure", "Contenu généré par LLM", "Métriques calculées", "Contenu de locale"],
        correct: 2,
        explanation: "Les nœuds aggregated contiennent des données calculées : GEOMetrics, SEOKeywordMetrics.",
    },
    QuizQuestionI18n {
    ...
    QuizQuestionI18n {
        ...
        options: &["Conception database-first", "Cypher est la source de vérité", "Pattern REST API", "Approche GraphQL"],
        correct: 1,
    ...
    QuizQuestionI18n {
        ...
        options: &["Budget de traduction", "Le knowledge n'existe que là où c'est nécessaire", "Alphabet différent", "Taille de la population"],
        correct: 1,
