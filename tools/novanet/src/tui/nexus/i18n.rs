...
pub fn tips(locale: NexusLocale) -> &'static [&'static str] {
    match locale {
        ...
        NexusLocale::Fr => &[
            ...
            "2 realms : Shared (36 nœuds) + Org (23 nœuds) = 59 au total",
...
pub fn intro_page3(locale: NexusLocale) -> &'static [&'static str] {
    match locale {
        NexusLocale::En => &[
            "THE GRAPH STRUCTURE (v0.20.0)",
            "",
            "59 node types organized by:",
            "  • Realm (WHERE): shared (36) | org (23)",
            "  • Layer (WHAT): 10 functional layers",
            "",
            "159 arc types organized by:",
        ...
        NexusLocale::Fr => &[
            "LA STRUCTURE DU GRAPHE (v0.20.0)",
            "",
            "59 types de nœuds organisés par :",
            "  • Realm (OÙ) : shared (36) | org (23)",
            "  • Layer (QUOI) : 10 couches fonctionnelles",
            "",
            "159 types d'arcs organisés par :",
            "  • Family : ownership | localization | semantic | generation | mining",
            "  • Scope : intra_realm | cross_realm",
            "",
...
static QUIZ_EN: [QuizQuestionI18n; 15] = [
    ...
    QuizQuestionI18n {
        question: "How many node types are in NovaNet v0.20.0?",
        options: &["45", "59", "75", "90"],
        correct: 1,
        explanation: "59 nodes: 36 in Shared realm + 23 in Org realm.",
    },
    QuizQuestionI18n {
