...
/// Build a FxHashMap for a category (called once at startup).
...
/// Get all realm icons.
pub fn realm_icons() -> FxHashMap<&'static str, IconDef> {
    icon_map! {
...
/// Get all layer icons.
pub fn layer_icons() -> FxHashMap<&'static str, IconDef> {
    icon_map! {
...
/// Get all trait icons.
pub fn trait_icons() -> FxHashMap<&'static str, IconDef> {
    icon_map! {
...
pub fn arc_family_icons() -> FxHashMap<&'static str, IconDef> {
    icon_map! {
...
/// Get all state icons.
pub fn state_icons() -> FxHashMap<&'static str, IconDef> {
    icon_map! {
        "error" => STATES_ERROR,
...
pub fn navigation_icons() -> FxHashMap<&'static str, IconDef> {
    icon_map! {
...
pub fn quality_icons() -> FxHashMap<&'static str, IconDef> {
    icon_map! {
        "chart" => QUALITY_CHART,
...
/// Get all mode icons.
pub fn mode_icons() -> FxHashMap<&'static str, IconDef> {
    icon_map! {
        "atlas" => MODES_ATLAS,
        "audit" => MODES_AUDIT,
        "data" => MODES_DATA,
