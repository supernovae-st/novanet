...
pub const TRAITS_RETRIEVED: IconDef =
    IconDef::new("cloud-download", "▪", "Fetched from EXTERNAL APIs");
...
pub const ARC_FAMILIES_SCHEMA: IconDef =
    IconDef::new("git-branch", "◇", "Meta-schema relationships");
