...
//!
//! v0.17.3 (ADR-036): Traits removed from schema-level, provenance is per-instance.
//!
...
mod tests {
    ...
    // v0.17.3 (ADR-036): NodeTraitDef removed, provenance is per-instance
    ...
    fn generate_small_cypher() {
        ...
        // v0.17.3 (ADR-036): Traits removed from header count
    ...
    fn generate_taxonomy_integration() {
        ...
        // v0.17.3 (ADR-036): Trait border style assertions removed, provenance is per-instance
