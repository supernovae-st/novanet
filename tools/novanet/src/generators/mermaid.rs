...
pub const TRAIT_STYLES: &[(&str, &str, &str)] = &[
    ...
    ("aggregated", "#6c71c4", "#5761b3"), // violet
];
...
fn render_mermaid(
    ...
    writeln!(out, "  %% NovaNet Graph v11.3.0").unwrap();
...
pub fn wrap_in_markdown(mermaid_code: &str) -> String {
    ...
    writeln!(
        out,
        "> Auto-generated by novanet v11.3.0. Do not edit manually."
    )
    .unwrap();
    writeln!(out).unwrap();
...
mod tests {
    ...
    fn render_small_mermaid() {
        ...
        let nodes = vec![
            ...
            make_node("ProjectContent", "org", "foundation", NodeTrait::Localized),
        ];
        ...
        assert!(output.contains("NovaNet Graph v11.3.0"));
    ...
    fn render_edge_families_distinct_arrows() {
        let nodes = vec![
            make_node("A", "shared", "config", NodeTrait::Invariant),
            make_node("B", "shared", "config", NodeTrait::Localized),
    ...
    fn wrap_in_markdown_includes_structure() {
        ...
        assert!(markdown.contains("Auto-generated by novanet v11.3.0"));
    ...
    fn generate_mermaid_integration() {
        ...
        // Sample layer subgraphs (v11.3: 3 shared + 8 org)
        ...
        assert!(output.contains("ORG_seo"));
        assert!(output.contains("ORG_geo")); // v11.3: GEO split from SEO
        assert!(output.contains("ORG_output"));

        // All 5 classDef trait styles (v11.2: split derived → generated + aggregated)
        ...
        assert!(output.contains("classDef aggregated"));
        ...
        assert!(output.contains("class Locale invariant"));
        assert!(output.contains("class Project invariant"));
        assert!(output.contains("class PageGenerated generated")); // v11.2: split derived → generated
