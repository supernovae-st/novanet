...
fn render_mermaid(
    ...
    writeln!(out, "  %% NovaNet Graph v11.0.0").unwrap();
...
mod tests {
    ...
    fn render_small_mermaid() {
        ...
        assert!(output.contains("NovaNet Graph v11.0.0"));
    ...
    fn wrap_in_markdown_includes_structure() {
        ...
        assert!(markdown.contains("Auto-generated by novanet v11.0.0"));
    ...
    fn generate_mermaid_integration() {
        ...
        assert!(output.contains("GLOBAL_config"));
        assert!(output.contains("GLOBAL_locale-knowledge"));
        assert!(output.contains("TENANT_foundation"));
        assert!(output.contains("TENANT_structure"));
        assert!(output.contains("TENANT_semantic"));
        assert!(output.contains("TENANT_instruction"));
        assert!(output.contains("TENANT_output"));
