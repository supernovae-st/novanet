...
mod tests {
    ...
    fn render_small_mermaid() {
        ...
        let nodes = vec![
            ...
            make_node("ProjectContent", "org", "foundation", NodeTrait::Authored),
        ];
        ...
        assert!(output.contains("NovaNet Graph v0.12.0"));
        ...
        assert!(output.contains("class ProjectContent authored"));
    }
    ...
    fn wrap_in_markdown_includes_structure() {
        ...
        assert!(markdown.contains("Auto-generated by novanet v0.12.0"));
