...
fn render_mermaid(
    ...
    writeln!(out, "  %% NovaNet Graph v11.2.0").unwrap();
...
mod tests {
    ...
    fn render_small_mermaid() {
        ...
        assert!(output.contains("NovaNet Graph v11.2.0"));
    ...
    fn wrap_in_markdown_includes_structure() {
        ...
        assert!(markdown.contains("Auto-generated by novanet v11.2.0"));
    ...
    fn generate_mermaid_integration() {
        ...
        assert!(output.contains("SHARED_config"));
        assert!(output.contains("SHARED_locale-knowledge"));
        assert!(output.contains("ORG_foundation"));
