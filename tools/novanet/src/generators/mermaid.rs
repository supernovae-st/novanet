...
fn render_mermaid(
    ...
    writeln!(out, "  %% NovaNet Graph v11.4.0").unwrap();
...
pub fn wrap_in_markdown(mermaid_code: &str) -> String {
    ...
    writeln!(
        out,
        "> Auto-generated by novanet v11.4.0. Do not edit manually."
    )
    .unwrap();
    writeln!(out).unwrap();
...
mod tests {
    ...
    fn render_small_mermaid() {
        ...
        assert!(output.contains("NovaNet Graph v11.4.0"));
    ...
    fn wrap_in_markdown_includes_structure() {
        ...
        assert!(markdown.contains("Auto-generated by novanet v11.4.0"));
