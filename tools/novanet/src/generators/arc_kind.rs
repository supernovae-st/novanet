...
fn generate_arc_schema(doc: &ArcsDocument, temps: &HashMap<String, f32>) -> crate::Result<String> {
    ...
    .unwrap();
    writeln!(out, "// ArcKind Meta-Nodes — v10.2.0").unwrap();
...
mod tests {
    ...
    fn generate_arc_schema_integration() {
        ...
        // v10.2: Count non-inverse relations (65 total - 5 inverse = 60)
        // Added: HAS_SEO_KEYWORDS (Locale → SEOKeyword ownership)
        let ak_merges = cypher
            .lines()
            .filter(|l: &&str| l.contains("MERGE") && l.contains(":Meta:ArcKind"))
            .count();
        ...
        // v10.2: Total non-inverse arcs = 60 (added HAS_SEO_KEYWORDS)
        assert!(
        ...
        // v10.2: Header reflects count (60 after HAS_SEO_KEYWORDS addition)
