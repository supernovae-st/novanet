...
mod tests {
    ...
    fn render_small_hierarchy() {
        ...
        // 2 realms present (v10.2: shared removed)
        ...
        // JSDoc header (v10.2: shared removed)
    ...
    fn generate_hierarchy_integration() {
        ...
        // Realm sections (v10.2: shared removed, seo moved to global)
        assert!(output.contains("GLOBAL (3 layers)")); // config, knowledge, seo
        assert!(output.contains("PROJECT (5 layers)"));

        // Total
        assert!(output.contains("2 Realms (8 layers)")); // shared removed
