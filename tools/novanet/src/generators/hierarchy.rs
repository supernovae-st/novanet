//! Generate `hierarchy.ts` via MiniJinja template (organizing-principles → TypeScript).
//!
//! Reads `organizing-principles.yaml` and produces the realm → layer hierarchy tree
