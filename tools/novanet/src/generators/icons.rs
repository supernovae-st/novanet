...
//!
//! Reads all 44 node YAMLs and extracts their `icon` emoji field.
//!
...
mod tests {
    ...
    fn generate_icons_integration() {
        ...
        // Header
        assert!(output.contains("AUTO-GENERATED by novanet v10.0.0"));
        assert!(output.contains("SINGLE SOURCE OF TRUTH"));

        // Should have all 46 nodes
        assert!(output.contains("NODE ICONS (46 nodes)"));
        ...
        assert!(output.contains("Concept: '"), "should have Concept entry");
