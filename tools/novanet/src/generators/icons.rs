...
//! Updated to support { web: "lucide-name", terminal: "◆" } format.
//!
...
/// Icon entry for template rendering (dual format).
 ...
 *
 * Updated to dual format { web, terminal }
 */
...
mod tests {
    ...
    fn generate_icons_integration() {
        ...
        assert!(
            ...
            "should have PageNative with dual format (ADR-029)"
        );
