...
fn generate_autowire(nodes: &[yaml_node::ParsedNode]) -> crate::Result<String> {
    ...
    .unwrap();
    writeln!(out, "//").unwrap();
    writeln!(out, "// AUTO-GENERATED by novanet v11.3.0 — DO NOT EDIT").unwrap();
...
mod tests {
    ...
    fn generate_autowire_integration() {
        ...
        // v11.3: Layer counts (3 shared + 8 org = 11 layers)
        ...
        assert!(cypher.contains("Shared > Knowledge (19 types)")); // Sets + Atoms
