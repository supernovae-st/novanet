...
fn generate_autowire(nodes: &[yaml_node::ParsedNode]) -> crate::Result<String> {
    ...
    .unwrap();
    writeln!(out, "//").unwrap();
    writeln!(out, "// AUTO-GENERATED by novanet v11.2.0 — DO NOT EDIT").unwrap();
...
mod tests {
    ...
    fn generate_autowire_integration() {
        ...
        assert!(cypher.contains("Shared > Config (14 types)")); // Locale + 6 utility + 6 geo/econ + EntityCategory
        assert!(cypher.contains("Shared > Locale-knowledge (18 types)")); // Sets + Atoms + 6 knowledge
