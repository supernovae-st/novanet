...
//!
//! Reads `organizing-principles.yaml` and produces color tokens for:
//! - Realms (3)
//! - Layers (9)
//! - Traits (5)
//! - ArcFamilies (5)
...
// Color tokens from organizing-principles.yaml (SINGLE SOURCE OF TRUTH)
...
fn render_colors(doc: &OrganizingDoc) -> crate::Result<String> {
    ...
    // Extract layers (nested under realms)
...
mod tests {
    ...
    fn render_colors_basic() {
        ...
        assert!(output.contains("export type RealmKey = 'global' | 'project'"));
