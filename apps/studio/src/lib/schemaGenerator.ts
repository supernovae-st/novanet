 ...
 * ---
 *
 * (Legacy) Generates the ontological schema graph (57 node types + relationships)
 * for "Schema Mode" visualization.
 *
 * v0.18.0: 57 nodes, 10 layers, 2 realms (*Native Pattern architecture)
...
/**
 * Generate schema graph with all 57 node types and their relationships
 * v0.18.0: 57 nodes, 10 layers, 2 realms
 *
...
export function generateSchemaGraph(): SchemaGraphResult {
  ...
  // Generate nodes for all 57 node types
