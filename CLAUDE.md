...
**Current Version**: v0.17.2 "Schema Cleanup Complete" (YAGNI: removed Term/TermSet, 57 nodes, 133 arcs)
...
- **57 nodes** total: 36 shared + 21 org, **133 arcs** (6 families)
...
v0.17.2: 2 realms (shared, org), 10 layers total (4 shared + 6 org), 57 nodes, 133 arcs.
