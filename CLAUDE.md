...
schema generate/validate, doc list, filter build. Galaxy-themed TUI with unified tree mode (v11.7), boot animation, effects engine, Nexus hub, and onboarding. 1068 tests.
...
| tools/novanet | Rust CLI + TUI — all runtime commands (1068 tests) |
